...
typedef enum
{
    ...
    E_MHAL_VENC_264_BUF_CTL, //MHAL_VENC_InternalBuf_t, RT
    E_MHAL_VENC_264_IN_OUT_Buf, //MHAL_VENC_InOutBuf_t, RT
    E_MHAL_VENC_264_All, //MHAL_VENC_ParamModH264e_t, RT
    ...
    E_MHAL_VENC_265_RC, ///< @ref MHAL_VENC_RcPriorityCfg_t, RT
