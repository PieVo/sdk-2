...
MS_S32 MHAL_CMDQ_GetNextMlodRignBufWritePtr_ByRiu(MHAL_CMDQ_CmdqInterface_t *pCmdinf, MS_PHYADDR* phyWritePtr)
{
    //not support
    return MHAL_SUCCESS;
}
...
MHAL_CMDQ_CmdqInterface_t *MHAL_CMDQ_GetSysCmdqService(MHAL_CMDQ_Id_e eCmdqId, MHAL_CMDQ_BufDescript_t *pCmdqBufDesp, MS_BOOL bForceRIU)
{
    ...
    if (pCmdqOps[eCmdqId] == NULL) {
        ...
        if (eCmdqId == E_MHAL_CMDQ_ID_DIVP) {
            ...
            if (bForceRIU) {
                pCmdq->MHAL_CMDQ_GetNextMlodRignBufWritePtr     = MHAL_CMDQ_GetNextMlodRignBufWritePtr_ByRiu;
                ...
                pCmdq->MHAL_CMDQ_GetNextMlodRignBufWritePtr     = MHAL_CMDQ_GetNextMlodRignBufWritePtr;
