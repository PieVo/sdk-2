...
//#define MHVE_CFG_DMA_OUTPUT_BUFFER
    ...
    struct
    {
        ...
        uint mbr_gn_w;
        uint mbr_gn_r;
        uint refconY[2];                          // reconstructed/reference Y buffer
        uint refconC[2];                          // reconstructed/reference C buffer
        uint colsadr[2];                          // colocated info buffer for writing/reading
        ...
        //uint col_sadr_buf[2];                     // 0:colocated info buffer for writing, 1:colocated info buffer for reading
        //uint cur_y_base_buf;
        //uint cur_c_base_buf;
    } hev_buff_addr;
};
