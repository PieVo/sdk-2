...
/*
#define MMHE_AVC_PROFILE_BP     66      //!< H.264 Base Line Profile
#define MMHE_AVC_PROFILE_MP     77      //!< H.264 Main Profile
#define MMHE_AVC_LEVEL_3        30      //!< H.264 Level-3.0
#define MMHE_AVC_LEVEL_31       31      //!< H.264 Level-3.1
#define MMHE_AVC_LEVEL_32       32      //!< H.264 Level-3.2
#define MMHE_AVC_LEVEL_4        40      //!< H.264 Level-4.0
*/
