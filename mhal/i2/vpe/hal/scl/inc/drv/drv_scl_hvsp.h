...
INTERFACE void DrvSclHvspSetPrv2CropOnOff(u8 bEn, void *pvCtx);
...
INTERFACE void DrvSclHvspRelease(DrvSclHvspIdType_e HVSP_IP,void *pvCtx);
...
INTERFACE void DrvSclHvspSetCropWindowSize(void *pvCtx);
