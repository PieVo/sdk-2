...
INTERFACE DrvSclDmaAttrType_t DrvSclDmaGetDmaInformationByClient
...
INTERFACE u64 DrvSclDmaGetSclFrameDoneTime(DrvSclDmaClientType_e enClientType, u8 u8Count);
