...
INTERFACE void HalSclVipSetWdrMloadConfig(bool bEn,u32 u32WdrBuf);
INTERFACE void HalSclVipSetNrHistOnOff(bool bEn);
INTERFACE void HalSclVipSetWdrMloadBuffer(u32 u32Buffer);
INTERFACE s32 HalSclVipGetWdrHistogram(u16 idx);
INTERFACE s32 HalSclVipGetWdrRHistogram(u16 idx);
INTERFACE s32 HalSclVipGetWdrGHistogram(u16 idx);
INTERFACE s32 HalSclVipGetWdrBHistogram(u16 idx);
INTERFACE s32 HalSclVipGetWdrYCntHistogram(u16 idx);
