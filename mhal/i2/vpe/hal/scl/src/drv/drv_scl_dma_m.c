...
void _MDrvSclDmaFillActiveBufferStruct
    (MDrvSclDmaIdType_e enSCLDMA_ID, MDrvSclDmaActiveBufferConfig_t *pstCfg,
    DrvSclDmaIdType_e *enID,bool bReadDMAMode,DrvSclDmaActiveBufferConfig_t *stActiveCfg)
{
    ...
    stActiveCfg->pvCtx = pstCfg->pvCtx;
}
    ...
    (MDrvSclDmaIdType_e enSCLDMA_ID, MDrvSclDmaTriggerConfig_t *pCfg)
{
    ...
    bool  bRet;
    DrvSclOsMemset(&stOnOffCfg,0,sizeof(DrvSclDmaOnOffConfig_t));
    ...
    (MDrvSclDmaIdType_e enSCLDMA_ID, MDrvSclDmaActiveBufferConfig_t *pstCfg)
{
    ...
    DrvSclDmaIdType_e enID;
    bool bRet;
    DrvSclOsMemset(&stActiveCfg,0,sizeof(DrvSclDmaActiveBufferConfig_t));
    SCL_DBG(SCL_DBG_LV_SCLDMA()&(Get_DBGMG_SCLDMA(enSCLDMA_ID,pstCfg->enMemType,1)), "[SCLDMA]%s\n", __FUNCTION__);
    _MDrvSclDmaFillActiveBufferStruct(enSCLDMA_ID,pstCfg,&enID,1,&stActiveCfg);
    ...
    (MDrvSclDmaIdType_e enSCLDMA_ID, MDrvSclDmaBUfferQueueConfig_t *pstCfg)
{
    ...
    DrvSclOsMemset(&stCfg,0,sizeof(DrvSclDmaBufferQueueConfig_t));
    SCL_DBG(SCL_DBG_LV_SCLDMA()&(Get_DBGMG_SCLDMA(enSCLDMA_ID,pstCfg->enMemType,1)), "[SCLDMA]%s\n", __FUNCTION__);
    ...
    (MDrvSclDmaIdType_e enSCLDMA_ID, MDrvSclDmaActiveBufferConfig_t *pstCfg)
{
    ...
    DrvSclOsMemset(&stActiveCfg,0,sizeof(DrvSclDmaActiveBufferConfig_t));
    SCL_DBG(SCL_DBG_LV_SCLDMA()&(Get_DBGMG_SCLDMA(enSCLDMA_ID, pstCfg->enMemType,1)), "[SCLDMA]%s\n", __FUNCTION__);
    _MDrvSclDmaFillActiveBufferStruct(enSCLDMA_ID, pstCfg, &enID,0,&stActiveCfg);
    bRet = _MDrvSclDmaGetDmaBufferActiveIdx(enID, pstCfg, &stActiveCfg);
    return bRet;
}
    ...
    (MDrvSclDmaGetConfig_t *stGetCfg,MDrvSclDmaAttrType_t *stSendToIOCfg)
{
    ...
    stDrvDMACfg = DrvSclDmaGetDmaInformationByClient(enID, enRWMode,stGetCfg->pvCtx);
    ...
    (char *buf, MDrvSclDmaIdType_e enID, MDrvSclDmaMemType_e enMem, bool bRread)
{
    ...
    //out =0,in=1
    stGetCfg.enSCLDMA_ID = enID;
    stGetCfg.enMemType = enMem;
    stGetCfg.bReadDMAMode = bRread;
