...
irqreturn_t  _DrvSclIrqisr(int eIntNum, void* dev_id)
{
    ...
    u32 u32DiffTime = 0;
    bool bCmdq = 0;
    u64Mask = pgstScldmaInfo->u64mask;
    ...
    if(u64Flag &SCLIRQ_MSK_AFF_FULL)
    {
        ...
        _DrvSclIrqAffFullHandler(1);
    }
    if(u64Flag &SCLIRQ_MSK_SC_IN_FRM_END)
    {
        _DrvSclIrqFrameInEndHandler();
        gstSCInts.u32ISPDoneCount++;
        u32DiffTime = gu32Time - gu32ActTime[E_DRV_SCLIRQ_CLK_FCLK_LDC];
    ...
    {
        _DrvSclIrqIDCLKVsyncInRealTimeHandler();
        SCL_DBG(SCL_DBG_LV_DRVSCLIRQ()&(EN_DBGMG_SCLIRQLEVEL_ELSE),"[IDCLK]Flag:%llx @%lu\n",u64Flag,gu32Time);
    }
    if(u64Flag &SCLIRQ_MSK_VSYNC_FCLK_LDC)
    {
        gu32ActTime[E_DRV_SCLIRQ_CLK_FCLK_LDC] = gu32Time;
        gstSCInts.u32ISPInCount++;
        if(DrvSclOsGetEvent(DrvSclIrqGetIrqSYNCEventID())&(E_DRV_SCLIRQ_EVENT_FRMENDSYNC))
        {
            u32DiffTime = gu32Time - gu32ActTime[E_DRV_SCLIRQ_CLK_FRMDONE];
    ...
    if(u64Flag & SCLIRQ_MSK_SC1_FRM_W_ACTIVE_N)
    {
        ...
        u32DiffTime = gu32Time - gu32ActTime[E_DRV_SCLIRQ_CLK_SC1FRMACT];
    ...
    {
        gu32ActTime[E_DRV_SCLIRQ_CLK_SC2FRMACT] = gu32Time;
    ...
    if(u64Flag & SCLIRQ_MSK_SC2_FRM_W_ACTIVE_N)
    {
        ...
        u32DiffTime = gu32Time -gu32ActTime[E_DRV_SCLIRQ_CLK_SC2FRMACT];
    ...
    {
        gu32ActTime[E_DRV_SCLIRQ_CLK_SC2FRM2ACT] = gu32Time;
    ...
    if(u64Flag & SCLIRQ_MSK_SC2_FRM2_W_ACTIVE_N)
    {
        ...
        u32DiffTime = gu32Time -gu32ActTime[E_DRV_SCLIRQ_CLK_SC2FRM2ACT];
    ...
    {
        gu32ActTime[E_DRV_SCLIRQ_CLK_SC1SNPACT] = gu32Time;
    ...
    if(u64Flag & SCLIRQ_MSK_SC1_SNP_W_ACTIVE_N)
    {
        ...
        u32DiffTime = gu32Time -gu32ActTime[E_DRV_SCLIRQ_CLK_SC1SNPACT];
    ...
    if(u64Flag &SCLIRQ_MSK_SC1_ENG_FRM_END)
    {
        ...
        gu32ActTime[E_DRV_SCLIRQ_CLK_FRMDONE] = gu32Time;
        u32DiffTime = gu32Time -gu32ActTime[E_DRV_SCLIRQ_CLK_FCLK_LDC];
    ...
    if(u64Flag & SCLIRQ_MSK_SC3_DMA_W_ACTIVE)
    {
        ...
        gu32ActTime[E_DRV_SCLIRQ_CLK_SC3FRMACT] = gu32Time;
    }
    ...
    if(u64Flag & SCLIRQ_MSK_SC3_DMA_W_ACTIVE_N)
    {
        ...
        u32DiffTime = gu32Time -gu32ActTime[E_DRV_SCLIRQ_CLK_SC3FRMACT];
...
#endif
irqreturn_t  _DrvSclIrqDvrisrTest(int eIntNum, void* dev_id)
{
    u64 u64Flag;
