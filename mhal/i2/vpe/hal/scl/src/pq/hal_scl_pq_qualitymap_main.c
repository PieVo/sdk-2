...
#include "Infinity2_Main_HSPRule.c"          // table config parameter
#include "Infinity2_Main_VSPRule.c"          // table config parameter
#include "Infinity2_Main_GRule.c"            // table config parameter
#include "Infinity2_Main_1920_GRule.c"       // table config parameter
#endif
