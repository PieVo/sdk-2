...
#define LOW_CLK 0x4
#define LOCK_FB()                       (gstGlobalHalHvspSet->gblockfbmg)
...
void HalSclHvspExit(void)
{
    ...
    gstGlobalHalHvspSet->gblockfbmg = 0;
...
void HalSclHvspFclk1(DrvSclHvspClkConfig_t *stclk)
{
    ...
    {
        if(IsClkIncrease(gstGlobalHalHvspSet->gu16height[0],gstGlobalHalHvspSet->gu16width[0],DrvSclOsClkGetRate(stclk->fclk1)))
        {
        ...
        else if(IsClkDecrease(gstGlobalHalHvspSet->gu16height[0],gstGlobalHalHvspSet->gu16width[0],DrvSclOsClkGetRate(stclk->fclk1)))
        {
...
void HalSclHvspFclk2(DrvSclHvspClkConfig_t *stclk)
{
    ...
    {
        if(IsClkIncrease(gstGlobalHalHvspSet->gu16height[1],gstGlobalHalHvspSet->gu16width[1],DrvSclOsClkGetRate(stclk->fclk2)))
        {
            if (NULL != (pstclock = DrvSclOsClkGetParentByIndex(stclk->fclk2, 0)))
            {
                DrvSclOsClkSetParent(stclk->fclk2, pstclock);
        ...
        else if(IsClkDecrease(gstGlobalHalHvspSet->gu16height[1],gstGlobalHalHvspSet->gu16width[1],DrvSclOsClkGetRate(stclk->fclk2)))
        {
            if (NULL != (pstclock = DrvSclOsClkGetParentByIndex(stclk->fclk2, 1)))
            {
                DrvSclOsClkSetParent(stclk->fclk2, pstclock);
...
void HalSclHvspSetFrameBufferManageLock(bool bEn)
{
    ...
    pvCtx = (void *)MDrvSclCtxGetConfigCtx(MDRV_SCL_CTX_ID_DEFAULT);
    _HalSclHvspSetGlobal((MDrvSclCtxCmdqConfig_t *)pvCtx);
    gstGlobalHalHvspSet->gblockfbmg = bEn;
}
void HalSclHvspSetResetDNR(bool bEn)
{
}
void HalSclHvspSramDumpbyMload(DrvSclHvspIdType_e enID,u32 u32Sram,bool bHer)
{
    u32 u32Addr = 0;
    u32 u32Reg = 0;
    bool bup = 0;
...
void HalSclHvspReSetHw(void *pvCtx)
{
    ...
    HalSclHvspSetIdClkOnOff(0,(DrvSclHvspClkConfig_t*)DrvSclOsClkGetConfig(E_DRV_SCLOS_CLK_ID_HVSP1));
}
...
void Hal_HVSP_Set_Hvsp_Sram_Coeff(DrvSclHvspIdType_e enID, HalSclHvspFilterSramSelType_e enSramSel, bool bC_SRAM, u8 *pData)
{
    ...
    {
        u32reg_41 = REG_SCL_HVSP3_41_L;
        u32reg_42 = REG_SCL_HVSP3_42_L;
        u32reg_43 = REG_SCL_HVSP3_43_L;
    }
    else
    {
...
void HalSclHvspSetCoverBypass(DrvSclHvspIdType_e enID,bool bEn)
{
    if(enID == E_DRV_SCLHVSP_ID_2)
    {
    }
...
u16 HalSclHvspGetHvspOutputHeightCount(DrvSclHvspIdType_e enID)
{
    ...
    {
        u16size = HalUtilityR2BYTEDirect(REG_SCL_HVSP3_26_L);
    }
    else
    {
...
void HalSclHvspSetPrv2CropOnOff(bool bEn)
{
    ...
    if(!LOCK_FB())
    {
        HalUtilityW2BYTEMSK(REG_UCM1_03_L, bEn ? BIT2 : 0, BIT2);
        ...
        {
            HalUtilityW2BYTEMSK(REG_VIP_MCNR_01_L, HalUtilityR2BYTE(REG_VIP_MCNR_01_L), BIT0);
        }
    }
...
{
    u16 u16Reg;
    u16Reg = HalUtilityR2BYTE(REG_UCM1_03_L);
    return ((u16Reg &BIT2)>>2);
}
