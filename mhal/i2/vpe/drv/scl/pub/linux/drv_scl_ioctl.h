...
#define IOCTL_SCL_SET_OSD_CONFIG_NR                 (9)   ///< The IOCTL NR definition for IOCTL_SCL_SET_OSD_CONFIG
#define IOCTL_SCL_SET_FB_MANAGE_CONFIG_NR           (10)  ///< The IOCTL NR definition for IOCTL_SCL_SET_FB_MANAGE_CONFIG
#define IOCTL_SCL_SET_PRIMASK_CONFIG_NR             (11)  ///< The IOCTL NR definition for IOCTL_SCL_SET_PRIMASK_CONFIG
#define IOCTL_SCL_PRIMASK_TRIGGER_CONFIG_NR         (12)  ///< The IOCTL NR definition for IOCTL_SCL_PRIMASK_TRIGGER_CONFIG
...
#define IOCTL_SCL_GET_IN_ACTIVE_BUFFER_CONFIG_NR    (21)  ///< The IOCTL NR definition for IOCTL_SCL_GET_IN_ACTIVE_BUFFER_CONFIG
#define IOCTL_SCL_GET_OUT_ACTIVE_BUFFER_CONFIG_NR   (22)  ///< The IOCTL NR definition for IOCTL_SCL_GET_OUT_ACTIVE_BUFFER_CONFIG
...
*/
#define IOCTL_SCLHVSP_SET_OSD_CONFIG             _IO(IOCTL_SCL_MAGIC,  IOCTL_SCL_SET_OSD_CONFIG_NR)
/**
* Setup FB management configuration of SCL for debugging. The structure of input parameter is DrvSclHvspIoSetFbManageConfig_t.
*/
#define IOCTL_SCLHVSP_SET_FB_MANAGE_CONFIG       _IO(IOCTL_SCL_MAGIC,  IOCTL_SCL_SET_FB_MANAGE_CONFIG_NR)
/**
...
*/
#define IOCTL_SCLHVSP_SET_PRIMASK_CONFIG         _IO(IOCTL_SCL_MAGIC,  IOCTL_SCL_SET_PRIMASK_CONFIG_NR)
/**
* Setup the PrivateMask Trigger configuration of SCL. The structure of input parameter is DrvSclHvspIoPriMaskTriggerConfig_t.
*/
#define IOCTL_SCLHVSP_PRIMASK_TRIGGER_CONFIG     _IO(IOCTL_SCL_MAGIC,  IOCTL_SCL_PRIMASK_TRIGGER_CONFIG_NR)
/**
...
*/
#define IOCTL_SCLDMA_SET_IN_TRIGGER_CONFIG          _IO(IOCTL_SCL_MAGIC,  IOCTL_SCL_SET_IN_TRIGGER_CONFIG_NR)
...
*/
#define IOCTL_SCLDMA_SET_OUT_TRIGGER_CONFIG         _IO(IOCTL_SCL_MAGIC,  IOCTL_SCL_SET_OUT_TRIGGER_CONFIG_NR)
...
*/
#define IOCTL_SCLDMA_GET_IN_ACTIVE_BUFFER_CONFIG    _IO(IOCTL_SCL_MAGIC,  IOCTL_SCL_GET_IN_ACTIVE_BUFFER_CONFIG_NR)
...
*/
#define IOCTL_SCLDMA_GET_OUT_ACTIVE_BUFFER_CONFIG   _IO(IOCTL_SCL_MAGIC,  IOCTL_SCL_GET_OUT_ACTIVE_BUFFER_CONFIG_NR)
