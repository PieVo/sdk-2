...
//////////////////////////////////////////////////////////////////
void _MDrv_Scl_PQ_Clear_SRAM_Table_Index(void)
{
#if(ENABLE_PQ_BIN)
...
#endif
    {
        MDrv_Scl_PQ_ClearTableIndex(MAIN);
    #if ENABLE_PQ_EX
        MDrv_Scl_PQ_ClearTableIndex(MAINEX);
    #endif

    #if PQ_ENABLE_PIP
        MDrv_Scl_PQ_ClearTableIndex(SUB);
        MDrv_Scl_PQ_ClearTableIndex(SUBEX);
    #endif

    #if ENABLE_MULTI_SCALER

        MDrv_Scl_PQ_ClearTableIndex(SC1_MAIN);
        MDrv_Scl_PQ_ClearTableIndex(SC1_MAINEX);

        MDrv_Scl_PQ_ClearTableIndex(SC2_MAIN);
        MDrv_Scl_PQ_ClearTableIndex(SC2_MAINEX);
        MDrv_Scl_PQ_ClearTableIndex(SC2_SUB);
        MDrv_Scl_PQ_ClearTableIndex(SC2_SUBEX);
    #endif
    }
}
bool MDrv_Scl_PQ_Exit(void)
{
    _MDrv_Scl_PQ_Clear_SRAM_Table_Index();
    if(_Scl_PQ_Mutex != -1)
    {
...
bool MDrv_Scl_PQ_Init(MS_PQ_Init_Info *pstPQInitInfo)
{
    ...
    if(pstPQInitInfo->u8PQTextBinCnt)
    {
        ...
        for(i = 0; i < pstPQInitInfo->u8PQTextBinCnt; i++)
        {
            ...
            {
                sclprintf("MDrv_PQTextBin_Parsing: Parsing Fail, ID=%d \n", i);
                return FALSE;
            }
        #endif
        }
    ...
    if(pstPQInitInfo->u8PQBinCnt)
    {
        ...
        for(i = 0; i < MAX_PQ_BIN_NUM; i++)
        {
            ...
            {
                sclprintf("MDrv_Scl_PQ_Init()  Error:  PQ_Bin_BufSize < 0 !!  \r\n");
            }
        }
    }
    else
#endif
    {
        ...
        #if (PQ_ENABLE_PIP)
            MDrv_Scl_PQ_Set_DisplayType_Sub(pstPQInitInfo->u16PnlWidth, PQ_DISPLAY_ONE, bSkipCommTable);
            MDrv_Scl_PQ_Set_DisplayType_SC2_Sub(pstPQInitInfo->u16PnlWidth, PQ_DISPLAY_ONE, bSkipCommTable);
            MDrv_Scl_PQ_Set_DisplayType_SC2_Main(pstPQInitInfo->u16PnlWidth, PQ_DISPLAY_ONE, bSkipCommTable);

            MDrv_Scl_PQ_Set_DisplayType_SC1_Main(pstPQInitInfo->u16PnlWidth, PQ_DISPLAY_ONE, bSkipCommTable);
        #endif

            #if(ENABLE_PQ_LOAD_TABLE_INFO)
            MDrv_Scl_PQ_PreInitLoadTableInfo(MAIN);

            #if ENABLE_PQ_EX
            MDrv_Scl_PQ_PreInitLoadTableInfo(MAINEX);
            #endif

            #if PQ_ENABLE_PIP
            MDrv_Scl_PQ_PreInitLoadTableInfo(SUB);
            MDrv_Scl_PQ_PreInitLoadTableInfo(SUBEX);
            #endif
            #endif
...
void MDrv_Scl_PQ_DesideSrcType(PQ_WIN eWindow, PQ_INPUT_SOURCE_TYPE enInputSourceType)
{
    ...
    Hal_Scl_PQ_set_sourceidx(eWindow, _u16SclPQSrcType[eWindow]);
...
#endif
        {
            MDrv_Scl_PQ_Set_LoadTableInfo_SrcType(MAIN, _u16SclPQSrcType[eWindow]);
            MDrv_Scl_PQ_Set_LoadTableInfo_SrcType(MAINEX, _u16SclPQSrcType[eWindow]);
        }
    }
#if PQ_ENABLE_PIP
...
#endif
        {
            MDrv_Scl_PQ_Set_LoadTableInfo_SrcType(SUB, _u16SclPQSrcType[eWindow]);
            MDrv_Scl_PQ_Set_LoadTableInfo_SrcType(SUBEX, _u16SclPQSrcType[eWindow]);
        }
    }
#endif
...
#endif
        {
            MDrv_Scl_PQ_Set_LoadTableInfo_SrcType(SC1_MAIN, _u16SclPQSrcType[eWindow]);
            MDrv_Scl_PQ_Set_LoadTableInfo_SrcType(SC1_MAINEX, _u16SclPQSrcType[eWindow]);
        }
    }
...
#endif
        {
            MDrv_Scl_PQ_Set_LoadTableInfo_SrcType(SC2_MAIN, _u16SclPQSrcType[eWindow]);
            MDrv_Scl_PQ_Set_LoadTableInfo_SrcType(SC2_MAINEX, _u16SclPQSrcType[eWindow]);
        }
    }
#if PQ_ENABLE_PIP
...
#endif
        {
            MDrv_Scl_PQ_Set_LoadTableInfo_SrcType(SC2_SUB, _u16SclPQSrcType[eWindow]);
            MDrv_Scl_PQ_Set_LoadTableInfo_SrcType(SC2_SUBEX, _u16SclPQSrcType[eWindow]);
        }
    }
#endif
...
bool MDrv_Scl_PQ_Set_DisplayType_Main(u16 u16DisplayWidth, PQ_DISPLAY_TYPE enDisplaType, bool bSkipCommTable)
{
    ...
    {
#if (PQ_ENABLE_UNUSED_FUNC)
        MDrv_Scl_PQ_LoadCommTable_(MAIN);
#endif
    }
    ...
    PQTableInfoEx.pIPTAB_Info = (void*)Scl_PQ_IPTAB_INFO_Main_Ex;
    ...
    MDrv_Scl_PQ_AddTable_(MAINEX, &PQTableInfoEx);
    if(!bSkipCommTable)
    {
        MDrv_Scl_PQ_LoadCommTable_(MAINEX);
    }
...
void MDRv_Scl_PQ_Check_Type(PQ_WIN eWindow, PQ_CHECK_TYPE EnCheck)
{
        if(eWindow == PQ_MAIN_WINDOW)
        {
#if(ENABLE_PQ_BIN)
...
#endif
            {
                MDrv_Scl_PQ_Check_Type_(MAIN, EnCheck);
...
{
    Hal_Scl_PQ_init_riu_base(riu_addr);
}
...
void MDrv_Scl_PQ_LoadSettings(PQ_WIN eWindow)
{
    if(eWindow == PQ_MAIN_WINDOW)
    {
        ...
        if(gbPQBinEnable)
        {
            ...
            MDrv_PQBin_LoadTableBySrcType(_u16SclPQSrcType[eWindow],
                                          PQ_BIN_IP_ALL,
...
#if(ENABLE_PQ_EX == 1)
            PQTAB_DBG(sclprintf("MAINEX table\r\n"));
            MDrv_Scl_PQ_LoadTableBySrcType_(MAINEX, _u16SclPQSrcType[eWindow], PQ_IP_ALL);
#endif
...
#if(ENABLE_PQ_MLOAD)
        MDrv_Scl_PQ_Set_MLoadEn(eWindow, TRUE);
#endif
#if PQ_UC_CTL
        MDrv_Scl_PQ_LoadTable(eWindow, MDrv_Scl_PQ_GetTableIndex(eWindow, PQ_IP_UC_CTL_Main), PQ_IP_UC_CTL_Main);
#endif
#if(ENABLE_PQ_MLOAD)
        MDrv_Scl_PQ_Set_MLoadEn(eWindow, FALSE);
#endif
    }
#if (PQ_ENABLE_PIP)
    else if(eWindow == PQ_SUB_WINDOW)
    {
        ...
        {
#if(PQ_ONLY_SUPPORT_BIN == 0)
            PQTAB_DBG(sclprintf("SUB table\r\n"));
            MDrv_Scl_PQ_LoadTableBySrcType_(SUB, _u16SclPQSrcType[eWindow], PQ_IP_ALL);

            PQTAB_DBG(sclprintf("SUB MAINEX table\r\n"));
            MDrv_Scl_PQ_LoadTableBySrcType_(SUBEX, _u16SclPQSrcType[eWindow], PQ_IP_ALL);
            PQTAB_DBG(sclprintf("...done\r\n"));
#endif
        }
    }
    ...
    else if(eWindow == PQ_SC1_MAIN_WINDOW)
    {
        ...
        {
#if(PQ_ONLY_SUPPORT_BIN == 0)
            PQTAB_DBG(sclprintf("SC1_MAIN table\r\n"));
            MDrv_Scl_PQ_LoadTableBySrcType_(SC1_MAIN, _u16SclPQSrcType[eWindow], PQ_IP_ALL);
#if(ENABLE_PQ_EX == 1)
            PQTAB_DBG(sclprintf("SC2_MAINEX table\r\n"));
            MDrv_Scl_PQ_LoadTableBySrcType_(SC1_MAINEX, _u16SclPQSrcType[eWindow], PQ_IP_ALL);
#endif
            PQTAB_DBG(sclprintf("...done\r\n"));
#endif
        }
...
#endif
#if PQ_UC_CTL
        MDrv_Scl_PQ_LoadTable(eWindow, MDrv_Scl_PQ_GetTableIndex(eWindow, PQ_IP_UC_CTL_SC1_Main), PQ_IP_UC_CTL_SC1_Main);
#endif
#if(ENABLE_PQ_MLOAD)
        MDrv_Scl_PQ_Set_MLoadEn(eWindow, FALSE);
#endif
    ...
    else if(eWindow == PQ_SC2_MAIN_WINDOW)
    {
        ...
        {
#if(PQ_ONLY_SUPPORT_BIN == 0)
            PQTAB_DBG(sclprintf("SC2_MAIN table\r\n"));
            MDrv_Scl_PQ_LoadTableBySrcType_(SC2_MAIN, _u16SclPQSrcType[eWindow], PQ_IP_ALL);
#if(ENABLE_PQ_EX == 1)
            PQTAB_DBG(sclprintf("SC2_MAINEX table\r\n"));
            MDrv_Scl_PQ_LoadTableBySrcType_(SC2_MAINEX, _u16SclPQSrcType[eWindow], PQ_IP_ALL);
#endif
            PQTAB_DBG(sclprintf("...done\r\n"));
#endif
        }
...
#endif
#if PQ_UC_CTL
        MDrv_Scl_PQ_LoadTable(eWindow, MDrv_Scl_PQ_GetTableIndex(eWindow, PQ_IP_UC_CTL_SC2_Main), PQ_IP_UC_CTL_SC2_Main);
#endif
#if(ENABLE_PQ_MLOAD)
        MDrv_Scl_PQ_Set_MLoadEn(eWindow, FALSE);
#endif
    ...
    else if(eWindow == PQ_SC2_SUB_WINDOW)
    {
        ...
        {
#if(PQ_ONLY_SUPPORT_BIN == 0)
            PQTAB_DBG(sclprintf("SC2_SUB table\r\n"));
            MDrv_Scl_PQ_LoadTableBySrcType_(SC2_SUB, _u16SclPQSrcType[eWindow], PQ_IP_ALL);

            PQTAB_DBG(sclprintf("SC2_SUB MAINEX table\r\n"));
            MDrv_Scl_PQ_LoadTableBySrcType_(SC2_SUBEX, _u16SclPQSrcType[eWindow], PQ_IP_ALL);
            PQTAB_DBG(sclprintf("...done\r\n"));
#endif
        }
    }
...
u16 MDrv_Scl_PQ_GetIPNum(PQ_WIN eWindow)
{
    if(eWindow == PQ_MAIN_WINDOW)
    {
...
#endif
        {
            ...
            return 0xFFFF;
#else
            return MDrv_Scl_PQ_GetIPNum_(MAIN);
#endif
        }
    }
    ...
    else if(eWindow == PQ_SUB_WINDOW)
    {
...
#endif
        {
            ...
            return 0xFFFF;
#else
            return MDrv_Scl_PQ_GetIPNum_(SUB);
#endif
        }
    }
#endif
    ...
    else if(eWindow == PQ_SC1_MAIN_WINDOW)
    {
...
#endif
        {
            ...
            return 0xFFFF;
#else
            return MDrv_Scl_PQ_GetIPNum_(SC1_MAIN);
#endif
        }
    }
    // SC2_MAIN
    else if(eWindow == PQ_SC2_MAIN_WINDOW)
    {
...
#endif
        {
            ...
            return 0xFFFF;
#else
            return MDrv_Scl_PQ_GetIPNum_(SC2_MAIN);
#endif
        }
    }
    // SC2_SUB
    ...
    else if(eWindow == PQ_SC2_SUB_WINDOW)
    {
...
#endif
        {
            ...
            return 0xFFFF;
#else
            return MDrv_Scl_PQ_GetIPNum_(SC2_SUB);
#endif
        }
    }
#endif
...
u16 MDrv_Scl_PQ_GetTableNum(PQ_WIN eWindow, u16 u16PQIPIdx)
{
    if(eWindow == PQ_MAIN_WINDOW)
    {
...
#endif
        {
            ...
            return 0xFFFF;
#else
            return MDrv_Scl_PQ_GetTableNum_(MAIN, (u8)u16PQIPIdx);
#endif
        }
    }
#if (PQ_ENABLE_PIP)
    else if(eWindow == PQ_SUB_WINDOW)
    {
...
#endif
        {
            ...
            return 0xFFFF;
#else
            return MDrv_Scl_PQ_GetTableNum_(SUB, (u8)u16PQIPIdx);
#endif
        }
    }
#endif
    ...
    else if(eWindow == PQ_SC1_MAIN_WINDOW)
    {
...
#endif
        {
            ...
            return 0xFFFF;
#else
            return MDrv_Scl_PQ_GetTableNum_(SC1_MAIN, (u8)u16PQIPIdx);
#endif
        }
    }
    else if(eWindow == PQ_SC2_MAIN_WINDOW)
    {
...
#endif
        {
            ...
            return 0xFFFF;
#else
            return MDrv_Scl_PQ_GetTableNum_(SC2_MAIN, (u8)u16PQIPIdx);
#endif
        }
    }
#if (PQ_ENABLE_PIP)
    else if(eWindow == PQ_SC2_SUB_WINDOW)
    {
...
#endif
        {
            ...
            return 0xFFFF;
#else
            return MDrv_Scl_PQ_GetTableNum_(SC2_SUB, (u8)u16PQIPIdx);
#endif
        }
    }
#endif
...
u16 MDrv_Scl_PQ_GetCurrentTableIndex(PQ_WIN eWindow, u16 u16PQIPIdx)
{
    if(eWindow == PQ_MAIN_WINDOW)
    {
...
#endif
        {
            ...
            return 0xFFFF;
#else
            return MDrv_Scl_PQ_GetCurrentTableIndex_(MAIN, (u8)u16PQIPIdx);
#endif
        }
    }
#if (PQ_ENABLE_PIP)
    else if(eWindow == PQ_SUB_WINDOW)
    {
...
#endif
        {
            ...
            return 0xFFFF;
#else
            return MDrv_Scl_PQ_GetCurrentTableIndex_(SUB, (u8)u16PQIPIdx);
#endif
        }
    }
#endif
    ...
    else if(eWindow == PQ_SC1_MAIN_WINDOW)
    {
...
#endif
        {
            ...
            return 0xFFFF;
#else
            return MDrv_Scl_PQ_GetCurrentTableIndex_(SC1_MAIN, (u8)u16PQIPIdx);
#endif
        }
    }
    ...
    else if(eWindow == PQ_SC2_MAIN_WINDOW)
    {
...
#endif
        {
            ...
            return 0xFFFF;
#else
            return MDrv_Scl_PQ_GetCurrentTableIndex_(SC2_MAIN, (u8)u16PQIPIdx);
#endif
        }
    }
#if (PQ_ENABLE_PIP)
    else if(eWindow == PQ_SC2_SUB_WINDOW)
    {
...
#endif
        {
            ...
            return 0xFFFF;
#else
            return MDrv_Scl_PQ_GetCurrentTableIndex_(SC2_SUB, (u8)u16PQIPIdx);
#endif
        }
    }
#endif
...
u16 MDrv_Scl_PQ_GetTableIndex(PQ_WIN eWindow, u16 u16IPIdx)
{
    u8 u16TabIdx = 0;
    ...
    if(eWindow == PQ_MAIN_WINDOW)
    {
        ...
        if(gbPQBinEnable)
        {
            u16TabIdx = (u8)MDrv_PQBin_GetTableIndex(_u16SclPQSrcType[eWindow],
                                                         u16IPIdx,
                                                        (u16)MDrv_PQBin_GetPanelIdx(PQ_MAIN_WINDOW),
                                                        &stPQBinHeaderInfo[PQ_BIN_STD_MAIN]);
        }
...
#endif
        {
            ...
            u16TabIdx = 0;
#else
            u16TabIdx = (u8)MDrv_Scl_PQ_GetTableIndex_(MAIN, _u16SclPQSrcType[eWindow], (u8)u16IPIdx);
#endif
        }
    }
#if (PQ_ENABLE_PIP)
    else if(eWindow == PQ_SUB_WINDOW)
    {
...
#endif
        {
            ...
            u16TabIdx = 0;
#else
            u16TabIdx = (u8)MDrv_Scl_PQ_GetTableIndex_(SUB, _u16SclPQSrcType[eWindow], (u8)u16IPIdx);
#endif
        }
    }
#endif
    ...
    else if(eWindow == PQ_SC1_MAIN_WINDOW)
    {
...
#endif
        {
            ...
            u16TabIdx = 0;
#else
            u16TabIdx = (u8)MDrv_Scl_PQ_GetTableIndex_(SC1_MAIN, _u16SclPQSrcType[eWindow], (u8)u16IPIdx);
#endif
        }
    }
    else if(eWindow == PQ_SC2_MAIN_WINDOW)
    {
...
#endif
        {
            ...
            u16TabIdx = 0;
#else
            u16TabIdx = (u8)MDrv_Scl_PQ_GetTableIndex_(SC2_MAIN, _u16SclPQSrcType[eWindow], (u8)u16IPIdx);
#endif
        }
    }
#if (PQ_ENABLE_PIP)
    else if(eWindow == PQ_SC2_SUB_WINDOW)
    {
...
#endif
        {
            ...
            u16TabIdx = 0;
#else
            u16TabIdx = (u8)MDrv_Scl_PQ_GetTableIndex_(SC2_SUB, _u16SclPQSrcType[eWindow], (u8)u16IPIdx);
#endif
        }
    }
#endif
...
static u16 MDrv_Scl_PQ_GetXRuleIPIndex(PQ_WIN eWindow, u16 u16XRuleType, u16 u16XRuleIP)
{
    u8 u16IPIdx = 0;
    if(eWindow == PQ_MAIN_WINDOW)
    {
...
#endif
        {
            ...
            u16IPIdx = 0;
#else
            u16IPIdx = MDrv_Scl_PQ_GetXRuleIPIndex_(MAIN, (u8)u16XRuleType, (u8)u16XRuleIP);
#endif
        }
    }
#if (PQ_ENABLE_PIP)
    else if(eWindow == PQ_SUB_WINDOW)
    {
...
#endif
        {
            ...
            u16IPIdx = 0;
#else
            u16IPIdx = MDrv_Scl_PQ_GetXRuleIPIndex_(SUB, (u8)u16XRuleType, (u8)u16XRuleIP);
#endif
        }
    }
#endif
    ...
    else if(eWindow == PQ_SC1_MAIN_WINDOW)
    {
...
#endif
        {
            ...
            u16IPIdx = 0;
#else
            u16IPIdx = MDrv_Scl_PQ_GetXRuleIPIndex_(SC1_MAIN, (u8)u16XRuleType, (u8)u16XRuleIP);
#endif
        }
    }
    else if(eWindow == PQ_SC2_MAIN_WINDOW)
    {
...
#endif
        {
            ...
            u16IPIdx = 0;
#else
            u16IPIdx = MDrv_Scl_PQ_GetXRuleIPIndex_(SC2_MAIN, (u8)u16XRuleType, (u8)u16XRuleIP);
#endif
        }
    }
#if (PQ_ENABLE_PIP)
    else if(eWindow == PQ_SC2_SUB_WINDOW)
    {
...
#endif
        {
            ...
            u16IPIdx = 0;
#else
            u16IPIdx = MDrv_Scl_PQ_GetXRuleIPIndex_(SC2_SUB, (u8)u16XRuleType, (u8)u16XRuleIP);
#endif
        }
    }
#endif
...
static u16 MDrv_Scl_PQ_GetXRuleTableIndex(PQ_WIN eWindow, u16 u16XRuleType, u16 u16XRuleIdx, u16 u16XRuleIP)
{
    u16 u16TabIdx = 0;
    ...
    if(eWindow == PQ_MAIN_WINDOW)
    {
...
#endif
        {
            ...
            u16TabIdx = 0;
#else
            u16TabIdx = MDrv_Scl_PQ_GetXRuleTableIndex_(MAIN, (u8)u16XRuleType, (u8)u16XRuleIdx, (u8)u16XRuleIP);
#endif
        }
    }
#if (PQ_ENABLE_PIP)
    else if(eWindow == PQ_SUB_WINDOW)
    {
...
#endif
        {
            ...
            u16TabIdx = 0;
#else
            u16TabIdx = MDrv_Scl_PQ_GetXRuleTableIndex_(SUB, (u8)u16XRuleType, (u8)u16XRuleIdx, (u8)u16XRuleIP);
#endif
        }
    }
#endif
    ...
    else if(eWindow == PQ_SC1_MAIN_WINDOW)
    {
...
#endif
        {
            ...
            u16TabIdx = 0;
#else
            u16TabIdx = MDrv_Scl_PQ_GetXRuleTableIndex_(SC1_MAIN, (u8)u16XRuleType, (u8)u16XRuleIdx, (u8)u16XRuleIP);
#endif
        }
    }
    else if(eWindow == PQ_SC2_MAIN_WINDOW)
    {
...
#endif
        {
            ...
            u16TabIdx = 0;
#else
            u16TabIdx = MDrv_Scl_PQ_GetXRuleTableIndex_(SC2_MAIN, (u8)u16XRuleType, (u8)u16XRuleIdx, (u8)u16XRuleIP);
#endif
        }
    }
#if (PQ_ENABLE_PIP)
    else if(eWindow == PQ_SC2_SUB_WINDOW)
    {
...
#endif
        {
            ...
            u16TabIdx = 0;
#else
            u16TabIdx = MDrv_Scl_PQ_GetXRuleTableIndex_(SC2_SUB, (u8)u16XRuleType, (u8)u16XRuleIdx, (u8)u16XRuleIP);
#endif
        }
    }
#endif
...
static u16 MDrv_Scl_PQ_GetXRuleIPNum(PQ_WIN eWindow, u16 u16XRuleType)
{
    u16 u16IPNum = 0;
    if(eWindow == PQ_MAIN_WINDOW)
    {
...
#endif
        {
            ...
            u16IPNum = 0;
#else
            u16IPNum = MDrv_Scl_PQ_GetXRuleIPNum_(MAIN, (u8)u16XRuleType);
#endif
        }
    }
#if (PQ_ENABLE_PIP)
    else if(eWindow == PQ_SUB_WINDOW)
    {
...
#endif
        {
            ...
            u16IPNum = 0;
#else
            u16IPNum = MDrv_Scl_PQ_GetXRuleIPNum_(SUB, (u8)u16XRuleType);
#endif
        }
    }
#endif
    ...
    else if(eWindow == PQ_SC1_MAIN_WINDOW)
    {
...
#endif
        {
            ...
            u16IPNum = 0;
#else
            u16IPNum = MDrv_Scl_PQ_GetXRuleIPNum_(SC1_MAIN, (u8)u16XRuleType);
#endif
        }
    }
    else if(eWindow == PQ_SC2_MAIN_WINDOW)
    {
...
#endif
        {
            ...
            u16IPNum = 0;
#else
            u16IPNum = MDrv_Scl_PQ_GetXRuleIPNum_(SC2_MAIN, (u8)u16XRuleType);
#endif
        }
    }
#if (PQ_ENABLE_PIP)
    else if(eWindow == PQ_SC2_SUB_WINDOW)
    {
...
#endif
        {
            ...
            u16IPNum = 0;
#else
            u16IPNum = MDrv_Scl_PQ_GetXRuleIPNum_(SC2_SUB, (u8)u16XRuleType);
#endif
        }
    }
#endif
...
static u16 MDrv_Scl_PQ_GetGRule_LevelIndex(PQ_WIN eWindow, u16 u16GRuleType, u16 u16GRuleLevelIndex)
{
    u16 u16Ret = 0;
    ...
    if(eWindow == PQ_MAIN_WINDOW)
    {
...
#endif
        {
            ...
            u16Ret = 0;
#else
            u16Ret = MDrv_Scl_PQ_GetGRule_LevelIndex_(MAIN, (u8)u16GRuleType, (u8)u16GRuleLevelIndex);
#endif
        }
    }
#if (PQ_ENABLE_PIP)
    else if(eWindow == PQ_SUB_WINDOW)
    {
...
#endif
        {
            ...
            u16Ret = 0;
#else
            u16Ret = MDrv_Scl_PQ_GetGRule_LevelIndex_(SUB, (u8)u16GRuleType, (u8)u16GRuleLevelIndex);
#endif
        }
    }
#endif
    ...
    else if(eWindow == PQ_SC1_MAIN_WINDOW)
    {
...
#endif
        {
            ...
            u16Ret = 0;
#else
            u16Ret = MDrv_Scl_PQ_GetGRule_LevelIndex_(SC1_MAIN, (u8)u16GRuleType, (u8)u16GRuleLevelIndex);
#endif
        }
    }
    else if(eWindow == PQ_SC2_MAIN_WINDOW)
    {
...
#endif
        {
            ...
            u16Ret = 0;
#else
            u16Ret = MDrv_Scl_PQ_GetGRule_LevelIndex_(SC2_MAIN, (u8)u16GRuleType, (u8)u16GRuleLevelIndex);
#endif
        }
    }
#if (PQ_ENABLE_PIP)
    else if(eWindow == PQ_SC2_SUB_WINDOW)
    {
...
#endif
        {
            ...
            u16Ret = 0;
#else
            u16Ret = MDrv_Scl_PQ_GetGRule_LevelIndex_(SC2_SUB, (u8)u16GRuleType, (u8)u16GRuleLevelIndex);
#endif
        }
    }
#endif
...
static u16 MDrv_Scl_PQ_GetGRule_IPIndex(PQ_WIN eWindow, u16 u16GRuleType, u16 u16GRuleIPIndex)
{
    u16 u16Ret = 0;
    if(eWindow == PQ_MAIN_WINDOW)
    {
...
#endif
        {
            ...
            u16Ret = 0;
#else
            u16Ret = MDrv_Scl_PQ_GetGRule_IPIndex_(MAIN, (u8)u16GRuleType, (u8)u16GRuleIPIndex);
#endif
        }
    }
#if (PQ_ENABLE_PIP)
    else if(eWindow == PQ_SUB_WINDOW)
    {
...
#endif
        {
            ...
            u16Ret = 0;
#else
            u16Ret = MDrv_Scl_PQ_GetGRule_IPIndex_(SUB, (u8)u16GRuleType, (u8)u16GRuleIPIndex);
#endif
        }
    }
#endif
    ...
    else if(eWindow == PQ_SC1_MAIN_WINDOW)
    {
...
#endif
        {
            ...
            u16Ret = 0;
#else
            u16Ret = MDrv_Scl_PQ_GetGRule_IPIndex_(SC1_MAIN, (u8)u16GRuleType, (u8)u16GRuleIPIndex);
#endif
        }
    }
    ...
    else if(eWindow == PQ_SC2_MAIN_WINDOW)
    {
...
#endif
        {
            ...
            u16Ret = 0;
#else
            u16Ret = MDrv_Scl_PQ_GetGRule_IPIndex_(SC2_MAIN, (u8)u16GRuleType, (u8)u16GRuleIPIndex);
#endif
        }
    }
#if (PQ_ENABLE_PIP)
    else if(eWindow == PQ_SUB_WINDOW)
    {
...
#endif
        {
            ...
            u16Ret = 0;
#else
            u16Ret = MDrv_Scl_PQ_GetGRule_IPIndex_(SC2_SUB, (u8)u16GRuleType, (u8)u16GRuleIPIndex);
#endif
        }
    }
#endif
...
static u16 MDrv_Scl_PQ_GetGRule_TableIndex(PQ_WIN eWindow, u16 u16GRuleType, u16 u16PQ_NRIdx, u16 u16GRuleIPIndex)
{
    u16 u16Ret = 0;
    if(eWindow == PQ_MAIN_WINDOW)
    {
...
#endif
        {
            ...
            u16Ret = 0;
#else
            u16Ret = (u8)MDrv_Scl_PQ_GetGRule_TableIndex_(MAIN, (u8)u16GRuleType, (u8)_u16SclPQSrcType[eWindow], (u8)u16PQ_NRIdx, (u8)u16GRuleIPIndex);
#endif
        }
    }
#if (PQ_ENABLE_PIP)
    else if(eWindow == PQ_SUB_WINDOW)
    {
...
#endif
        {
            ...
            u16Ret = 0;
#else
            u16Ret = (u8)(MDrv_Scl_PQ_GetGRule_TableIndex_(SUB, (u8)u16GRuleType, (u8)_u16SclPQSrcType[eWindow], (u8)u16PQ_NRIdx, (u8)u16GRuleIPIndex));
#endif
        }
    }
#endif
    ...
    else if(eWindow == PQ_SC1_MAIN_WINDOW)
    {
...
#endif
        {
            ...
            u16Ret = 0;
#else
            u16Ret = (u8)MDrv_Scl_PQ_GetGRule_TableIndex_(SC1_MAIN, (u8)u16GRuleType, (u8)_u16SclPQSrcType[eWindow], (u8)u16PQ_NRIdx, (u8)u16GRuleIPIndex);
#endif
        }
    }
    else if(eWindow == PQ_SC2_MAIN_WINDOW)
    {
...
#endif
        {
            ...
            u16Ret = 0;
#else
            u16Ret = (u8)MDrv_Scl_PQ_GetGRule_TableIndex_(SC2_MAIN, (u8)u16GRuleType, (u8)_u16SclPQSrcType[eWindow], (u8)u16PQ_NRIdx, (u8)u16GRuleIPIndex);
#endif
        }
    }
#if (PQ_ENABLE_PIP)
    else if(eWindow == PQ_SC2_SUB_WINDOW)
    {
...
#endif
        {
            ...
            u16Ret = 0;
#else
            u16Ret = (u8)(MDrv_Scl_PQ_GetGRule_TableIndex_(SC2_SUB, (u8)u16GRuleType, (u8)_u16SclPQSrcType[eWindow], (u8)u16PQ_NRIdx, (u8)u16GRuleIPIndex));
#endif
        }
    }
#endif
...
void MDrv_Scl_PQ_LoadTableData(PQ_WIN eWindow, u16 u16TabIdx, u16 u16PQIPIdx, u8 *pTable, u16 u16TableSize)
{
    if(eWindow == PQ_MAIN_WINDOW)
    {
#if(ENABLE_PQ_BIN)
        ...
        {
#if(PQ_ONLY_SUPPORT_BIN == 0)
            MDrv_Scl_PQ_LoadTableData_(MAIN, (u8)u16TabIdx, (u8)u16PQIPIdx, pTable, u16TableSize);
#endif
        }
    }
#if (PQ_ENABLE_PIP)
    else if(eWindow == PQ_SUB_WINDOW)
    {
        ...
        {
#if(PQ_ONLY_SUPPORT_BIN == 0)
            MDrv_Scl_PQ_LoadTableData_(SUB, (u8)u16TabIdx, (u8)u16PQIPIdx, pTable, u16TableSize);
#endif
        }
    }
#endif
    ...
    else if(eWindow == PQ_SC1_MAIN_WINDOW)
    {
        ...
        {
#if(PQ_ONLY_SUPPORT_BIN == 0)
            MDrv_Scl_PQ_LoadTableData_(SC1_MAIN, (u8)u16TabIdx, (u8)u16PQIPIdx, pTable, u16TableSize);
#endif
        }
    }
    else if(eWindow == PQ_SC2_MAIN_WINDOW)
    {
        ...
        {
#if(PQ_ONLY_SUPPORT_BIN == 0)
            MDrv_Scl_PQ_LoadTableData_(SC2_MAIN, (u8)u16TabIdx, (u8)u16PQIPIdx, pTable, u16TableSize);
#endif
        }
    }
#if (PQ_ENABLE_PIP)
    else if(eWindow == PQ_SC2_SUB_WINDOW)
    {
        ...
        {
#if(PQ_ONLY_SUPPORT_BIN == 0)
            MDrv_Scl_PQ_LoadTableData_(SC2_SUB, (u8)u16TabIdx, (u8)u16PQIPIdx, pTable, u16TableSize);
#endif
        }
    }
#endif
...
void MDrv_Scl_PQ_LoadTable(PQ_WIN eWindow, u16 u16TabIdx, u16 u16PQIPIdx)
{
    if(eWindow == PQ_MAIN_WINDOW)
    {
        ...
        {
#if(PQ_ONLY_SUPPORT_BIN == 0)
            MDrv_Scl_PQ_LoadTable_(MAIN, (u8)u16TabIdx, (u8)u16PQIPIdx);
#endif
        }
    }
#if (PQ_ENABLE_PIP)
    else if(eWindow == PQ_SUB_WINDOW)
    {
        ...
        {
#if(PQ_ONLY_SUPPORT_BIN == 0)
            MDrv_Scl_PQ_LoadTable_(SUB, (u8)u16TabIdx, (u8)u16PQIPIdx);
#endif
        }
    }
#endif
    ...
    else if(eWindow == PQ_SC1_MAIN_WINDOW)
    {
        ...
        {
#if(PQ_ONLY_SUPPORT_BIN == 0)
            MDrv_Scl_PQ_LoadTable_(SC1_MAIN, (u8)u16TabIdx, (u8)u16PQIPIdx);
#endif
        }
    }
    ...
    else if(eWindow == PQ_SC2_MAIN_WINDOW)
    {
        ...
        {
#if(PQ_ONLY_SUPPORT_BIN == 0)
            MDrv_Scl_PQ_LoadTable_(SC2_MAIN, (u8)u16TabIdx, (u8)u16PQIPIdx);
#endif
        }
    }
#if (PQ_ENABLE_PIP)
    else if(eWindow == PQ_SC2_SUB_WINDOW)
    {
        ...
        {
#if(PQ_ONLY_SUPPORT_BIN == 0)
            MDrv_Scl_PQ_LoadTable_(SC2_SUB, (u8)u16TabIdx, (u8)u16PQIPIdx);
#endif
        }
    }
#endif
...
void MDrv_Scl_PQ_CheckSettings(PQ_WIN eWindow)
{
    if(eWindow == PQ_MAIN_WINDOW)
    {
        ...
        if(gbPQBinEnable)
        {
            ...
            MDrv_PQBin_CheckTableBySrcType(_u16SclPQSrcType[eWindow],
                                           PQ_BIN_IP_ALL,
                                           (u16)MDrv_PQBin_GetPanelIdx(PQ_MAIN_WINDOW),
                                           &stPQBinHeaderInfo[PQ_BIN_STD_MAIN]);
        }
...
#if(PQ_ONLY_SUPPORT_BIN == 0)
#if(ENABLE_PQ_EX)
            MDrv_Scl_PQ_CheckCommTable_(MAINEX);
            MDrv_Scl_PQ_CheckTableBySrcType_(MAINEX, _u16SclPQSrcType[eWindow], PQ_IP_ALL);
#endif
            MDrv_Scl_PQ_CheckCommTable_(MAIN);
            MDrv_Scl_PQ_CheckTableBySrcType_(MAIN, _u16SclPQSrcType[eWindow], PQ_IP_ALL);
#endif
        }
    }
#if (PQ_ENABLE_PIP)
    else if(eWindow == PQ_SUB_WINDOW)
    {
        ...
        {
#if(PQ_ONLY_SUPPORT_BIN == 0)
            MDrv_Scl_PQ_CheckCommTable_(SUBEX);
            MDrv_Scl_PQ_CheckTableBySrcType_(SUBEX, _u16SclPQSrcType[eWindow], PQ_IP_ALL);
            MDrv_Scl_PQ_CheckCommTable_(SUB);
            MDrv_Scl_PQ_CheckTableBySrcType_(SUB, _u16SclPQSrcType[eWindow], PQ_IP_ALL);
#endif
        }
    }
#endif
...
#if(PQ_ONLY_SUPPORT_BIN == 0)
#if(ENABLE_PQ_EX)
            MDrv_Scl_PQ_CheckCommTable_(SC1_MAINEX);
            MDrv_Scl_PQ_CheckTableBySrcType_(SC1_MAINEX, _u16SclPQSrcType[eWindow], PQ_IP_ALL);
#endif
            MDrv_Scl_PQ_CheckCommTable_(SC1_MAIN);
            MDrv_Scl_PQ_CheckTableBySrcType_(SC1_MAIN, _u16SclPQSrcType[eWindow], PQ_IP_ALL);
#endif
        }
    }
...
#if(PQ_ONLY_SUPPORT_BIN == 0)
#if(ENABLE_PQ_EX)
            MDrv_Scl_PQ_CheckCommTable_(SC2_MAINEX);
            MDrv_Scl_PQ_CheckTableBySrcType_(SC2_MAINEX, _u16SclPQSrcType[eWindow], PQ_IP_ALL);
#endif
            MDrv_Scl_PQ_CheckCommTable_(SC2_MAIN);
            MDrv_Scl_PQ_CheckTableBySrcType_(SC2_MAIN, _u16SclPQSrcType[eWindow], PQ_IP_ALL);
#endif
        }
    }
#if (PQ_ENABLE_PIP)
    else if(eWindow == PQ_SC2_SUB_WINDOW)
    {
        ...
        {
#if(PQ_ONLY_SUPPORT_BIN == 0)
            MDrv_Scl_PQ_CheckCommTable_(SC2_SUBEX);
            MDrv_Scl_PQ_CheckTableBySrcType_(SC2_SUBEX, _u16SclPQSrcType[eWindow], PQ_IP_ALL);
            MDrv_Scl_PQ_CheckCommTable_(SC2_SUB);
            MDrv_Scl_PQ_CheckTableBySrcType_(SC2_SUB, _u16SclPQSrcType[eWindow], PQ_IP_ALL);
#endif
        }
    }
#endif
...
void MDrv_Scl_PQ_Set_MLoadEn(PQ_WIN eWindow, bool bEn)
{
    ...
    if(eWindow == PQ_MAIN_WINDOW)
    {
        ...
        {
#if(PQ_ONLY_SUPPORT_BIN == 0)
            MDrv_Scl_PQ_Set_MLoadEn_(MAIN, bEn);
#endif
        }
    ...
    else if(eWindow == PQ_SUB_WINDOW)
    {
        ...
        {
#if(PQ_ONLY_SUPPORT_BIN == 0)
            MDrv_Scl_PQ_Set_MLoadEn_(SUB, bEn);
#endif
        }
    }
#endif
    ...
    else if(eWindow == PQ_SC1_MAIN_WINDOW)
    {
        ...
        {
#if(PQ_ONLY_SUPPORT_BIN == 0)
            MDrv_Scl_PQ_Set_MLoadEn_(SC1_MAIN, bEn);
#endif
        }
    ...
    else if(eWindow == PQ_SC2_MAIN_WINDOW)
    {
        ...
        {
#if(PQ_ONLY_SUPPORT_BIN == 0)
            MDrv_Scl_PQ_Set_MLoadEn_(SC2_MAIN, bEn);
#endif
        }
    ...
    else if(eWindow == PQ_SC2_SUB_WINDOW)
    {
        ...
        {
#if(PQ_ONLY_SUPPORT_BIN == 0)
            MDrv_Scl_PQ_Set_MLoadEn_(SC2_SUB, bEn);
#endif
        }
    }
#endif
...
{
    DrvSclOsMemcpy(&_stDTV_Info[eWindow], pstPQDTVInfo, sizeof(MS_PQ_Dtv_Info));
...
{
    DrvSclOsMemcpy(&_stMultiMedia_Info[eWindow], pstPQMMInfo, sizeof(MS_PQ_MuliMedia_Info));
...
{
    DrvSclOsMemcpy(&_stVD_Info[eWindow], pstPQVDInfo, sizeof(MS_PQ_Vd_Info));
...
void MDrv_Scl_PQ_Set_ModeInfo(PQ_WIN eWindow, PQ_INPUT_SOURCE_TYPE enInputSourceType, MS_PQ_Mode_Info *pstPQModeInfo)
{
    ...
    DrvSclOsMemcpy(&_stMode_Info[eWindow], pstPQModeInfo, sizeof(MS_PQ_Mode_Info));
...
{
    return _u16SclPQSrcType[eWindow];
}

// if not HSD case, ignore return value
static bool _MDrv_Scl_PQ_LoadScalingTable(PQ_WIN eWindow,
        u8 eXRuleType,
        u8 u8XRuleIP,
        ...
        u16 u16SizeAfterScaling)
{
    ...
    u16IPIdx = MDrv_Scl_PQ_GetXRuleIPIndex(eWindow, eXRuleType, u8XRuleIP);
    ...
    if(bPreV_ScalingDown && bInterlace)
    {
        ...
        u16TabIdx = MDrv_Scl_PQ_GetXRuleTableIndex(eWindow, (u16)eXRuleType, (u16)u8XRuleIdx, (u16)u8XRuleIP);
    }
...
#endif
    {
        if(u32Ratio > 1000)
        {
            u16TabIdx = MDrv_Scl_PQ_GetTableIndex(eWindow, u16IPIdx);
    ...
    // 1.VSD : V prescaling, 2. PIP, 3. FBL
        if((((eXRuleType == E_XRULE_VSD)&&(bPreV_ScalingDown))
            ...
            ) && (PQ_IP_DMS_V_12L_Main == MDrv_Scl_PQ_GetXRuleIPIndex(eWindow, eXRuleType, u8XRuleIP))
        )
        {
            //Disable De-Mosquito
    ...
    MDrv_Scl_PQ_LoadTable(eWindow, u16TabIdx, u16IPIdx);
                                 ...
                                 u16 u16SizeAfterScaling)
{
    ...
    for(i = 0; i < MDrv_Scl_PQ_GetXRuleIPNum(eWindow, (u16)eXRuleType); i++)
    {
        bool bSDMode;
        bSDMode = _MDrv_Scl_PQ_LoadScalingTable(eWindow,
                                            eXRuleType,
                                            (u8)i,
                                            bPreV_ScalingDown,
                                            bInterlace,
        ...
        (MApi_XC_Get_3D_HW_Version() > 0))
    {
        if((u16InputSize >= u16SizeAfterScaling) && (eXRuleType == E_XRULE_VSP))
        {
            ...
            MDrv_Scl_PQ_LoadTable(PQ_MAIN_WINDOW, PQ_IP_VSP_Y_SRAM_1_4Tap_Main, PQ_IP_VSP_Y_Main);
            MDrv_Scl_PQ_LoadTable(PQ_MAIN_WINDOW, PQ_IP_VSP_C_C_SRAM_1_Main, PQ_IP_VSP_C_Main);
            MDrv_Scl_PQ_LoadTable(PQ_MAIN_WINDOW, PQ_IP_SRAM1_InvSinc4Tc4p4Fc50Apass01Astop55_Main, PQ_IP_SRAM1_Main);
            MDrv_Scl_PQ_LoadTable(PQ_MAIN_WINDOW, PQ_IP_C_SRAM1_C121_Main, PQ_IP_C_SRAM1_Main);

            MDrv_Scl_PQ_LoadTable(PQ_SUB_WINDOW, PQ_IP_VSP_Y_SRAM_3_4Tap_Sub, PQ_IP_VSP_Y_Sub);
            MDrv_Scl_PQ_LoadTable(PQ_SUB_WINDOW, PQ_IP_VSP_C_C_SRAM_3_Sub, PQ_IP_VSP_C_Sub);
            MDrv_Scl_PQ_LoadTable(PQ_SUB_WINDOW, PQ_IP_SRAM3_InvSinc4Tc4p4Fc50Apass01Astop55_Sub, PQ_IP_SRAM3_Sub);
            MDrv_Scl_PQ_LoadTable(PQ_SUB_WINDOW, PQ_IP_C_SRAM3_C121_Sub, PQ_IP_C_SRAM3_Sub);
        }
    }
#endif
...
void MDrv_Scl_PQ_SetColorRange(PQ_WIN eWindow, bool bColorRange0_255)
{
    ...
    MDrv_Scl_PQ_SetCSC(eWindow, _gFourceColorFmt[eWindow]);
}

bool MDrv_Scl_PQ_Get_CSC_XRuleIdx(bool *pbInputColorSpaceRGB,
                                            u16 * pu16DoCSC,
                                            PQ_WIN eWindow,
                                            ...
                                            bool bLoadPQTable)
{
    ...
    if(MDrv_Scl_PQ_Get_PointToPoint(PQ_MAIN_WINDOW))
    {
    ...
    for(u16XRuleIP=0; u16XRuleIP<MDrv_Scl_PQ_GetXRuleIPNum(eWindow, eXRuleType); u16XRuleIP++)
    {
        u16IPIdx = MDrv_Scl_PQ_GetXRuleIPIndex(eWindow, eXRuleType, u16XRuleIP);
        u16TabIdx = MDrv_Scl_PQ_GetXRuleTableIndex(eWindow, eXRuleType, u16XRuleIdx, u16XRuleIP);
...
bool MDrv_Scl_PQ_Get_MemYUVFmt(PQ_WIN eWindow, PQ_FOURCE_COLOR_FMT enFourceColor)
{
    ...
    MDrv_Scl_PQ_Get_CSC_XRuleIdx(&bInputColorSpaceRGB, &u16DoCSC, eWindow, enFourceColor, FALSE);
...
bool MDrv_Scl_PQ_SetCSC(PQ_WIN eWindow, PQ_FOURCE_COLOR_FMT enFourceColor)
{
    ...
    MDrv_Scl_PQ_Get_CSC_XRuleIdx(&bInputColorSpaceRGB, &u16DoCSC, eWindow, enFourceColor, TRUE);
...
#if (PQ_GRULE_NR_ENABLE)
static void _MDrv_Scl_PQ_LoadNRTable(PQ_WIN eWindow, u16 u16PQ_NRIdx)
{
    ...
    if (eWindow == PQ_MAIN_WINDOW || eWindow == PQ_SC1_MAIN_WINDOW || eWindow == PQ_SC2_MAIN_WINDOW)
    {
        ...
        {
            u16IPIdx = MDrv_Scl_PQ_GetGRule_IPIndex(eWindow, u16GRule_Type, i);

            if(u16PQ_NRIdx == u16GRule_NR_Num)  // see it as default
                u16TabIdx = MDrv_Scl_PQ_GetTableIndex(eWindow, u16IPIdx);
            else
                u16TabIdx = MDrv_Scl_PQ_GetGRule_TableIndex(eWindow, u16GRule_Type, u16PQ_NRIdx, i);

            PQGRULE_DBG(sclprintf("[NR]SRC: %u, NR: %u, NRIPIdx:%u, IPIdx:%u, u16TabIdx:%u\r\n",
                           _u16SclPQSrcType[eWindow], u16PQ_NRIdx, i, u16IPIdx, u16TabIdx));
            MDrv_Scl_PQ_LoadTable(eWindow, u16TabIdx, u16IPIdx);
        }
    }
#if PQ_ENABLE_PIP
...
void MDrv_Scl_PQ_LoadNRTable(PQ_WIN eWindow, PQ_3D_NR_FUNCTION_TYPE en3DNRType)
{
    ...
    if (eWindow == PQ_MAIN_WINDOW || eWindow == PQ_SC1_MAIN_WINDOW || eWindow == PQ_SC2_MAIN_WINDOW)
    {
        ...
        if(en3DNRType == PQ_3D_NR_OFF)
        {
            ...
            u16GRule_Level = eWindow == PQ_MAIN_WINDOW     ? PQ_GRule_NR_Off_Main :
                        ...
                        #endif
                                                             0xFFFF;
            u16PQ_NRIdx = MDrv_Scl_PQ_GetGRule_LevelIndex(eWindow, u16GRule_Type, u16GRule_Level);
            _MDrv_Scl_PQ_LoadNRTable(eWindow, u16PQ_NRIdx);
        }
        ...
        else if(en3DNRType == PQ_3D_NR_DEFAULT)
        {
            ...
            _MDrv_Scl_PQ_LoadNRTable(eWindow,  u16NR_Idx);
        }
        else
        {
            SCL_ASSERT(0);
    ...
    if(QM_IsInterlaced(eWindow) && QM_IsSourceMultiMedia(MDrv_Scl_PQ_GetInputSourceType(eWindow)) && (MApi_XC_ReadByte(0x110D30)==0x66))
    {
        u16 u16Input_HSize;
        u16 u16Input_VSize;
...
static void _MDrv_Scl_PQ_LoadOSD_BWTable(PQ_WIN eWindow, u16 u16PQ_OSD_BW_Idx)
{
    u16 i, u16IPIdx = 0, u16TabIdx = 0;
    ...
    {
        u16IPIdx = MDrv_Scl_PQ_GetGRule_IPIndex(eWindow, PQ_GRule_OSD_BW_Main, i);

        if(u16PQ_OSD_BW_Idx == PQ_GRULE_OSD_BW_NUM_Main)  // see it as default
            u16TabIdx = MDrv_Scl_PQ_GetTableIndex(eWindow, u16IPIdx);
        else
            u16TabIdx = MDrv_Scl_PQ_GetGRule_TableIndex(eWindow, PQ_GRule_OSD_BW_Main, u16PQ_OSD_BW_Idx, i);

        PQGRULE_DBG(sclprintf("[NR]SRC: %u, NR: %u, NRIPIdx:%u, IPIdx:%u, u8TabIdx:%u\r\n",
                           _u16SclPQSrcType[eWindow], u16PQ_OSD_BW_Idx, i, u16IPIdx, u16IPIdx));
...
void MDrv_Scl_PQ_LoadOSD_BWTable(PQ_WIN eWindow, PQ_OSD_BW_FUNCTION_TYPE enOSD_BW_Type)
{
    u16 u16PQ_NRIdx;
    ...
    if(enOSD_BW_Type == PQ_OSD_BW_ON)
    {
       ...
       {
            u16PQ_NRIdx = MDrv_Scl_PQ_GetGRule_LevelIndex(eWindow, PQ_GRule_OSD_BW_Main, PQ_GRule_Lvl_OSD_BW_1DDR_On_Main);
            _MDrv_Scl_PQ_LoadOSD_BWTable(eWindow, u16PQ_NRIdx);
        }
        else
        {
            u16PQ_NRIdx = MDrv_Scl_PQ_GetGRule_LevelIndex(eWindow, PQ_GRule_OSD_BW_Main, PQ_GRule_Lvl_OSD_BW_2DDR_On_Main);
            _MDrv_Scl_PQ_LoadOSD_BWTable(eWindow, u16PQ_NRIdx);
        }
        #else
        u16PQ_NRIdx = MDrv_Scl_PQ_GetGRule_LevelIndex(eWindow, PQ_GRule_OSD_BW_Main, PQ_GRule_Lvl_OSD_BW_On_Main);
        _MDrv_Scl_PQ_LoadOSD_BWTable(eWindow, u16PQ_NRIdx);
       #endif
    }
    else
...
#if PQ_GRULE_FILM_MODE_ENABLE
static void _MDrv_Scl_PQ_LoadFilmModeTable(PQ_WIN eWindow, u16 u16PQ_FilmModeIdx)
{
    u16 i, u16IPIdx = 0, u16TabIdx = 0;
    ...
    {
        u16IPIdx = MDrv_Scl_PQ_GetGRule_IPIndex(eWindow, PQ_GRule_FILM_MODE_Main, i);

        if(u16PQ_FilmModeIdx == PQ_GRULE_FILM_MODE_NUM_Main)  // see it as default
            u16TabIdx = MDrv_Scl_PQ_GetTableIndex(eWindow, u16TabIdx);
        else
            u16TabIdx = MDrv_Scl_PQ_GetGRule_TableIndex(eWindow, PQ_GRule_FILM_MODE_Main, u16PQ_FilmModeIdx, i);

        PQGRULE_DBG(sclprintf("[FM]SRC: %u, FM: %u, FMIPIdx:%u, IPIdx:%u, u16TabIdx:%u\r\n",
                           _u16SclPQSrcType[eWindow], u16PQ_FilmModeIdx, i, u16IPIdx, u16TabIdx));
        MDrv_Scl_PQ_LoadTable(eWindow, u16TabIdx, u16IPIdx);
    }
}
#endif
...
void MDrv_Scl_PQ_LoadFilmModeTable(PQ_WIN eWindow, PQ_FILM_MODE_FUNCTION_TYPE enFilmModeType)
{
    ...
    {
        u16PQ_FilmModeIdx = MDrv_Scl_PQ_GetGRule_LevelIndex(eWindow, PQ_GRule_FILM_MODE_Main, PQ_GRule_FILM_MODE_Off_Main);
        _MDrv_Scl_PQ_LoadFilmModeTable(eWindow, u16PQ_FilmModeIdx);

    }
    else if(enFilmModeType == PQ_FilmMode_ON)
    {
        u16PQ_FilmModeIdx = MDrv_Scl_PQ_GetGRule_LevelIndex(eWindow, PQ_GRule_FILM_MODE_Main, PQ_GRule_FILM_MODE_On_Main);
        _MDrv_Scl_PQ_LoadFilmModeTable(eWindow, u16PQ_FilmModeIdx);
    }
    else
    {
...
#if PQ_GRULE_DYNAMIC_CONTRAST_ENABLE
static void _MDrv_Scl_PQ_DynamicContrastTable(PQ_WIN eWindow, u16 u16PQ_DynContrIdx)
{
    u16 i, u16IPIdx = 0, u16TabIdx = 0;
    ...
    {
        u16IPIdx = MDrv_Scl_PQ_GetGRule_IPIndex(eWindow, PQ_GRule_DYNAMIC_CONTRAST_Main, i);

        if(u16PQ_DynContrIdx == PQ_GRULE_DYNAMIC_CONTRAST_NUM_Main)  // see it as default
            u16TabIdx = MDrv_Scl_PQ_GetTableIndex(eWindow, u16TabIdx);
        else
            u16TabIdx = MDrv_Scl_PQ_GetGRule_TableIndex(eWindow, PQ_GRule_DYNAMIC_CONTRAST_Main, u16PQ_DynContrIdx, i);

        PQGRULE_DBG(sclprintf("[DC]SRC: %u, DC: %u, DCIPIdx:%u, IPIdx:%u, u16TabIdx:%u\r\n",
                           _u16SclPQSrcType[eWindow], u16PQ_DynContrIdx, i, u16IPIdx, u16TabIdx));
        MDrv_Scl_PQ_LoadTable(eWindow, u16TabIdx, u16IPIdx);
    }
}
#endif
...
void MDrv_Scl_PQ_LoadDynamicContrastTable(PQ_WIN eWindow, PQ_DYNAMIC_CONTRAST_FUNCTION_TYPE enDynamicContrastType)
{
    ...
    {
        u16PQ_DynContrIdx = MDrv_Scl_PQ_GetGRule_LevelIndex(eWindow, PQ_GRule_DYNAMIC_CONTRAST_Main, PQ_GRule_DYNAMIC_CONTRAST_Off_Main);
        _MDrv_Scl_PQ_DynamicContrastTable(eWindow, u16PQ_DynContrIdx);
    }
    else if(enDynamicContrastType == PQ_DynContr_ON)
    {
        u16PQ_DynContrIdx = MDrv_Scl_PQ_GetGRule_LevelIndex(eWindow, PQ_GRule_DYNAMIC_CONTRAST_Main, PQ_GRule_DYNAMIC_CONTRAST_On_Main);
        _MDrv_Scl_PQ_DynamicContrastTable(eWindow, u16PQ_DynContrIdx);
    }
    else
    {
...
#if PQ_GRULE_MPEG_NR_ENABLE
static void _MDrv_Scl_PQ_LoadMPEGNRTable(PQ_WIN eWindow, u16 u16PQ_NRIdx)
{
    u16 i, u16IPIdx = 0, u16TabIdx = 0;
    ...
    {
        u16IPIdx = MDrv_Scl_PQ_GetGRule_IPIndex(eWindow, PQ_GRule_MPEG_NR_Main, i);

        if(u16PQ_NRIdx == PQ_GRULE_MPEG_NR_NUM_Main)  // see it as default
            u16TabIdx = MDrv_Scl_PQ_GetTableIndex(eWindow, u16IPIdx);
        else
            u16TabIdx = MDrv_Scl_PQ_GetGRule_TableIndex(eWindow, PQ_GRule_MPEG_NR_Main, u16PQ_NRIdx, i);
...
void MDrv_Scl_PQ_LoadMPEGNRTable(PQ_WIN eWindow, PQ_MPEG_NR_FUNCTION_TYPE enMPEGNRType)
{
    ...
    {
        PQGRULE_DBG(sclprintf("Off\r\n"));
        u16PQ_NRIdx = MDrv_Scl_PQ_GetGRule_LevelIndex(eWindow, PQ_GRule_MPEG_NR_Main, PQ_GRule_MPEG_NR_Off_Main);
        _MDrv_Scl_PQ_LoadMPEGNRTable(eWindow, u16PQ_NRIdx);
    }
    else if( enMPEGNRType == PQ_MPEG_NR_AUTO )
    {
        // Auto NR will be process in msAPI_DynamicNR_Handler(), hence we only need to pre-setup the PQ table.
        PQGRULE_DBG(sclprintf("Auto\r\n"));
        u16PQ_NRIdx = MDrv_Scl_PQ_GetGRule_LevelIndex(eWindow, PQ_GRule_MPEG_NR_Main, PQ_GRule_MPEG_NR_Low_Main);
        _MDrv_Scl_PQ_LoadMPEGNRTable(eWindow, u16PQ_NRIdx);
    }
    ...
    {
        PQGRULE_DBG(sclprintf("Mid\r\n"));
        u16PQ_NRIdx = MDrv_Scl_PQ_GetGRule_LevelIndex(eWindow, PQ_GRule_MPEG_NR_Main, PQ_GRule_MPEG_NR_Middle_Main);
        _MDrv_Scl_PQ_LoadMPEGNRTable(eWindow, u16PQ_NRIdx);
    }
    else if(enMPEGNRType == PQ_MPEG_NR_HIGH)
    {
        PQGRULE_DBG(sclprintf("High\r\n"));
        u16PQ_NRIdx = MDrv_Scl_PQ_GetGRule_LevelIndex(eWindow, PQ_GRule_MPEG_NR_Main, PQ_GRule_MPEG_NR_High_Main);
        _MDrv_Scl_PQ_LoadMPEGNRTable(eWindow, u16PQ_NRIdx);
    }
    else if(enMPEGNRType == PQ_MPEG_NR_DEFAULT)
    {
        PQGRULE_DBG(sclprintf("Default\r\n"));
        _MDrv_Scl_PQ_LoadMPEGNRTable(eWindow, PQ_GRULE_MPEG_NR_NUM_Main);
    }
    else
    {
        SCL_ASSERT(0);
...
#if PQ_GRULE_ULTRAT_CLEAR_ENABLE
static void _MDrv_Scl_PQ_Load_ULTRACLEAR_Table(PQ_WIN eWindow, u16 u16PQ_ULTRACLEAR_Idx)
{
    ...
    {
        u16IPIdx = MDrv_Scl_PQ_GetGRule_IPIndex(eWindow, PQ_GRule_ULTRAT_CLEAR_Main, i);

        if(u16PQ_ULTRACLEAR_Idx == PQ_GRULE_ULTRAT_CLEAR_NUM_Main)  // see it as default
            u16TabIdx = MDrv_Scl_PQ_GetTableIndex(eWindow, u16IPIdx);
        else
            u16TabIdx = MDrv_Scl_PQ_GetGRule_TableIndex(eWindow, PQ_GRule_ULTRAT_CLEAR_Main, u16PQ_ULTRACLEAR_Idx, i);

        PQGRULE_DBG(sclprintf("[UC]SRC: %u, UC: %u, UCIPIdx:%u, IPIdx:%u, u8TabIdx:%u\r\n",
                           _u16SclPQSrcType[eWindow], u16PQ_ULTRACLEAR_Idx, i, u16IPIdx, u16IPIdx));
...
void MDrv_Scl_PQ_Load_ULTRACLEAR_Table(PQ_WIN eWindow, PQ_FEATURE_SWITCH_TYPE enCtrlType)
{
    ...
    {
        PQGRULE_DBG(sclprintf("On\r\n"));
        u16PQ_TableIdx = MDrv_Scl_PQ_GetGRule_LevelIndex(eWindow, PQ_GRule_ULTRAT_CLEAR_Main, PQ_GRule_ULTRAT_CLEAR_On_Main);
        _MDrv_Scl_PQ_Load_ULTRACLEAR_Table(eWindow, u16PQ_TableIdx);
    }
    else
    {
        PQGRULE_DBG(sclprintf("Off\r\n"));
        u16PQ_TableIdx = MDrv_Scl_PQ_GetGRule_LevelIndex(eWindow, PQ_GRule_ULTRAT_CLEAR_Main, PQ_GRule_ULTRAT_CLEAR_Off_Main);
        _MDrv_Scl_PQ_Load_ULTRACLEAR_Table(eWindow, u16PQ_TableIdx);
    }
#else
...
u8 _MDrv_Scl_PQ_wait_output_vsync(PQ_WIN ePQWin, u8 u8NumVSyncs, u16 u16Timeout)
{
    u32 u32Time;
    u8 bVSync;
...
u8 _MDrv_Scl_PQ_wait_input_vsync(PQ_WIN ePQWin,  u8 u8NumVSyncs, u16 u16Timeout)
{
    u32 u32Time;
    //bool bMainWin = (ePQWin == PQ_MAIN_WINDOW) ? TRUE : FALSE;
...
#if (PQ_XRULE_DB_ENABLE == 1)
void MDrv_Scl_PQ_Set_DBRule(PQ_WIN eWindow, u16 u16MADi_Idx)
{
    u16 eXRuleType = E_XRULE_CSC;
    u16 u16XRuleIdx, u16XRuleIP;
    u16 u16IPIdx, u16TabIdx;
...
//
PQ_DEINTERLACE_MODE MDrv_Scl_PQ_SetMemFormat(PQ_WIN eWindow, bool bMemFmt422, bool bFBL, u8 *pu8BitsPerPixel)
{
    ...
    if(!bFBL)
    {
        ...
        if(((_stMode_Info[eWindow].u16input_hsize >= 1280) && (_stMode_Info[eWindow].u16input_vsize >= 720)) &&
                (_bOSD_On))
        {
            MDrv_Scl_PQ_GetMADiFromGrule(eWindow, &u16TabIdx_MADi_Motion, &u16TabIdx_MADi);
        }
        else
#endif
        {
            MDrv_Scl_PQ_GetMADiInGeneral(eWindow, &u16TabIdx_MADi_Motion, &u16TabIdx_MADi);
#if PQ_GRULE_OSD_BW_ENABLE
            MDrv_Scl_PQ_Patch2Rto4RForFieldPackingMode(eWindow, u16TabIdx_MADi);
#endif
        }

        MDrv_Scl_PQ_GetMADiForRFBL(eWindow, bFBL, &u16TabIdx_MADi_Motion, &u16TabIdx_MADi);
    }
    else // FBL
    {
    ...
    MDrv_Scl_PQ_GetMemFmtInGeneral(eWindow, bMemFmt422, &u16TabIdx_MemFormat, &u16TabIdx_444To422, &u16TabIdx_422To444);
    ...
    MDrv_Scl_PQ_GetBPPInfoFromMADi(eWindow, bMemFmt422, u16TabIdx_MADi, u16TabIdx_MemFormat, pu8BitsPerPixel, &eDeInterlaceMode, &u8FrameCount);

    PQMADi_DBG(sclprintf("BitPerPixel =%d, DIMode =%x\r\n", *pu8BitsPerPixel, eDeInterlaceMode));

    _gbMemfmt422[eWindow] = bMemFmt422;

    MDrv_Scl_PQ_ChangeMemConfigFor3D(eWindow, bMemFmt422, &u16TabIdx_MemFormat, &u16TabIdx_444To422, &u16TabIdx_422To444,
      ...
      )
    {
        ...
        MDrv_Scl_PQ_LoadTable(eWindow, u16TabIdx_MemFormat, u16IPIdx);
        ...
        u16IPIdx =  eWindow == PQ_MAIN_WINDOW     ? PQ_IP_MADi_Main :
                ...
                #endif
                                                    0xFFFF;
        MDrv_Scl_PQ_LoadTable(eWindow, u16TabIdx_MADi, u16IPIdx);
#if PQ_GRULE_OSD_BW_ENABLE
        if(0xFFFF != u16TabIdx_MADi_Motion)
        {
            ...
            u16IPIdx =  eWindow == PQ_MAIN_WINDOW     ? PQ_IP_MADi_Motion_Main :
                    ...
                    #endif
                                                        0xFFFF;
            MDrv_Scl_PQ_LoadTable(eWindow, u16TabIdx_MADi_Motion, u16IPIdx);
        }
#endif
        u16IPIdx =  eWindow == PQ_MAIN_WINDOW     ? PQ_IP_444To422_Main :
                ...
                #endif
                                                    0xFFFF;
        MDrv_Scl_PQ_LoadTable(eWindow, u16TabIdx_444To422, u16IPIdx);
        ...
        u16IPIdx =  eWindow == PQ_MAIN_WINDOW     ? PQ_IP_422To444_Main :
                ...
                #endif
                                                    0xFFFF;
        MDrv_Scl_PQ_LoadTable(eWindow, u16TabIdx_422To444, u16IPIdx);
    }
#if PQ_ENABLE_PIP
    else
    {
...
#if (PQ_XRULE_DB_ENABLE == 1)
    MDrv_Scl_PQ_Set_DBRule(eWindow, u16TabIdx_MADi);
#endif

    MDrv_Scl_PQ_ForceBPPForDynamicMemFmt(eWindow, bMemFmt422, pu8BitsPerPixel);
    MDrv_Scl_PQ_SetFrameNumber(eWindow, u16TabIdx_MADi, u8FrameCount);
...
void _MDrv_Scl_PQ_Set_MVOP_UVShift(bool bEnable)
{
    u8 regval;
...
void MDrv_Scl_PQ_Set420upsampling(PQ_WIN eWindow,
                              bool bFBL,
                              bool bPreV_ScalingDown,
                              u16 u16V_CropStart)
{
    ...
    u16TabIdx = MDrv_Scl_PQ_GetTableIndex(eWindow, PQ_IP_420CUP_Main);

    PQTAB_DBG(sclprintf("[PQ_Set420upsampling]: SrcType:%u, FBL:%u, PreV down:%u, V_CropStart:%u, u8TabIdx=%u, ",
                     _u16SclPQSrcType[eWindow], bFBL, bPreV_ScalingDown, u16V_CropStart, u16TabIdx));

    if((u16TabIdx == Hal_PQ_get_420_cup_idx(MS_420_CUP_ON)) && (!bPreV_ScalingDown) && (!bFBL))
    {
        PQTAB_DBG(sclprintf("UVShift: on\r\n"));
        _MDrv_Scl_PQ_Set_MVOP_UVShift(ENABLE);
        MDrv_Scl_PQ_LoadTable(eWindow, Hal_PQ_get_420_cup_idx(MS_420_CUP_ON), PQ_IP_420CUP_Main);
    }
    else    // P mode should not do UV shift
    {
        PQTAB_DBG(sclprintf("UVShift: off\r\n"));
        _MDrv_Scl_PQ_Set_MVOP_UVShift(DISABLE);
        MDrv_Scl_PQ_LoadTable(eWindow, Hal_PQ_get_420_cup_idx(MS_420_CUP_OFF), PQ_IP_420CUP_Main);
    }
...
void MDrv_Scl_PQ_SetFilmMode(PQ_WIN eWindow, bool bEnable)
{
    ...
    if(bEnable)
        u16TabIdx = MDrv_Scl_PQ_GetTableIndex(eWindow, PQ_IP_Film32_Main);
    else
        u16TabIdx = PQ_IP_Film32_OFF_Main;

    MDrv_Scl_PQ_LoadTable(eWindow, u16TabIdx, PQ_IP_Film32_Main);

    if(bEnable)
        u16TabIdx = MDrv_Scl_PQ_GetTableIndex(eWindow, PQ_IP_Film22_Main);
    else
        u16TabIdx = PQ_IP_Film22_OFF_Main;

    MDrv_Scl_PQ_LoadTable(eWindow, u16TabIdx, PQ_IP_Film22_Main);
#endif
}
...
void MDrv_Scl_PQ_SetNonLinearScaling(PQ_WIN eWindow, u8 u8Level, bool bEnable)
{
    ...
    MDrv_Scl_PQ_LoadTable(eWindow, u16TabIdx, PQ_IP_HnonLinear_Main);
#endif
}
...
void MDrv_Scl_PQ_DisableFilmMode(PQ_WIN eWindow, bool bOn)
{
    if(bOn)
    {
        MDrv_Scl_PQ_SetFilmMode(eWindow, DISABLE);
    }
    else
    {
        MDrv_Scl_PQ_SetFilmMode(eWindow, ENABLE);
    }
}
...
bool MDrv_Scl_PQ_DisableUCFeature(PQ_WIN eWindow)
{
    ...
    {
        MDrv_Scl_PQ_LoadTable(PQ_MAIN_WINDOW, PQ_IP_UCNR_OFF_Main, PQ_IP_UCNR_Main);
        MDrv_Scl_PQ_LoadTable(PQ_MAIN_WINDOW, PQ_IP_UC_CTL_OFF_Main, PQ_IP_UC_CTL_Main);
        MDrv_Scl_PQ_LoadTable(PQ_MAIN_WINDOW, PQ_IP_UCDi_OFF_Main, PQ_IP_UCDi_Main);
    }
#if PQ_ENABLE_PIP
    else if(PQ_SUB_WINDOW == eWindow)
    {
    #if defined(AMBER3)
        MDrv_Scl_PQ_LoadTable(PQ_SUB_WINDOW, PQ_IP_UCNR_OFF_Sub, PQ_IP_UCNR_Sub);
        MDrv_Scl_PQ_LoadTable(PQ_SUB_WINDOW, PQ_IP_UC_CTL_OFF_Sub, PQ_IP_UC_CTL_Sub);
        MDrv_Scl_PQ_LoadTable(PQ_SUB_WINDOW, PQ_IP_UCDi_OFF_Sub, PQ_IP_UCDi_Sub);
    #endif
    }
#endif
    ...
    {
        MDrv_Scl_PQ_LoadTable(PQ_SC1_MAIN_WINDOW, PQ_IP_UCNR_OFF_SC1_Main, PQ_IP_UCNR_SC1_Main);
        MDrv_Scl_PQ_LoadTable(PQ_SC1_MAIN_WINDOW, PQ_IP_UC_CTL_OFF_SC1_Main, PQ_IP_UC_CTL_SC1_Main);
        MDrv_Scl_PQ_LoadTable(PQ_SC1_MAIN_WINDOW, PQ_IP_UCDi_OFF_SC1_Main, PQ_IP_UCDi_SC1_Main);
    }
    else if(PQ_SC2_MAIN_WINDOW == eWindow)
    {
        MDrv_Scl_PQ_LoadTable(PQ_SC2_MAIN_WINDOW, PQ_IP_UCNR_OFF_SC2_Main, PQ_IP_UCNR_SC2_Main);
        MDrv_Scl_PQ_LoadTable(PQ_SC2_MAIN_WINDOW, PQ_IP_UC_CTL_OFF_SC2_Main, PQ_IP_UC_CTL_SC2_Main);
        MDrv_Scl_PQ_LoadTable(PQ_SC2_MAIN_WINDOW, PQ_IP_UCDi_OFF_SC2_Main, PQ_IP_UCDi_SC2_Main);
    }
#if PQ_ENABLE_PIP
    else if(PQ_SUB_WINDOW == eWindow)
    {
    #if defined(AMBER3)
        MDrv_Scl_PQ_LoadTable(PQ_SC2_SUB_WINDOW, PQ_IP_UCNR_OFF_SC2_Sub, PQ_IP_UCNR_SC2_Sub);
        MDrv_Scl_PQ_LoadTable(PQ_SC2_SUB_WINDOW, PQ_IP_UC_CTL_OFF_SC2_Sub, PQ_IP_UC_CTL_SC2_Sub);
        MDrv_Scl_PQ_LoadTable(PQ_SC2_SUB_WINDOW, PQ_IP_UCDi_OFF_SC2_Sub, PQ_IP_UCDi_SC2_Sub);
    #endif
    }
#endif
#endif
...
{
    DrvSclOsMemcpy((void*)pInfo, (void*)&_info, sizeof(MS_PQ_INFO));
    return E_PQ_RET_OK;
}

bool  MDrv_Scl_PQ_GetStatus(MS_PQ_Status *pStatus)
{
    DrvSclOsMemcpy((void*)pStatus, (void*)&_status, sizeof(MS_PQ_Status));
    return FALSE;
}
...
void MDrv_Scl_PQ_Set_DisplayType(u16 u16DisplayWidth, PQ_DISPLAY_TYPE enDisplaType, PQ_WIN ePQWin)
{
...
#endif
    {
        ...
        {
            MDrv_Scl_PQ_Set_DisplayType_Sub(u16DisplayWidth, enDisplaType, bSkipCommTable);
            MDrv_Scl_PQ_Set_DisplayType_Main(u16DisplayWidth, enDisplaType, bSkipCommTable);
            MDrv_Scl_PQ_Set_DisplayType_SC2_Sub(u16DisplayWidth, enDisplaType, bSkipCommTable);
            MDrv_Scl_PQ_Set_DisplayType_SC2_Main(u16DisplayWidth, enDisplaType, bSkipCommTable);
            MDrv_Scl_PQ_Set_DisplayType_SC1_Main(u16DisplayWidth, enDisplaType, bSkipCommTable);
...
void MDrv_Scl_PQ_SetRFblMode(bool bEnable, bool bFilm)
{
    ...
    {
        MDrv_Scl_PQ_MADiForceMotionY(PQ_MAIN_WINDOW, FALSE);
        MDrv_Scl_PQ_MADiForceMotionC(PQ_MAIN_WINDOW, FALSE);
    ...
    else
    {
        ...
        MDrv_Scl_PQ_MADiForceMotionY(PQ_MAIN_WINDOW, FALSE);
        MDrv_Scl_PQ_MADiForceMotionC(PQ_MAIN_WINDOW, (!bFilm));

        //sclprintf("[%s]-[%d] : Y/C motion : ( 0 , %d) \r\n", __FUNCTION__, __LINE__,(!bFilm));
    }
}

void MDrv_Scl_PQ_GetRFblMode(MS_PQ_RFBL_INFO * pstInfo)
{
    DrvSclOsMemcpy(pstInfo, &_stRFBL_Info, sizeof(MS_PQ_RFBL_INFO));
    return;
}
...
bool MDrv_Scl_PQ_Get_VDSampling_Info(PQ_WIN eWindow, PQ_INPUT_SOURCE_TYPE enInputSourceType, PQ_VIDEOSTANDARD_TYPE eStandard, MS_PQ_VD_Sampling_Info *pInfo)
{
    ...
    u16 u16CurSrc = _u16SclPQSrcType[eWindow];
    u16 u16TableIdx;
    u16 u16IPIdx = Hal_PQ_get_ip_idx(MS_PQ_IP_VD_SAMPLING);
    u8 u8SampleTable[10];

    DrvSclOsMemset(u8SampleTable, 0, sizeof(u8SampleTable));
            ...
            (u16IPIdx != 0xFFFF))
    {
        ...
        u16TableIdx = MDrv_Scl_PQ_GetTableIndex(eWindow, u16IPIdx);
        ...
        {
            MDrv_Scl_PQ_LoadTableData(eWindow, u16TableIdx, u16IPIdx, u8SampleTable, 10);
        ...
        _u16SclPQSrcType[eWindow] = u16CurSrc;
    }
    else
    {
        pInfo->eType = PQ_VD_SAMPLING_OFF;
...
bool _MDrv_Scl_PQ_Get_HSDSampling(PQ_WIN eWindow, u32 *pu32ratio, bool *bADVMode)
{
#if PQ_ENABLE_HSDRULE
    ...
    if(bret)
    {
        ...
        u16HSD_Y_idx = MDrv_Scl_PQ_GetTableIndex(eWindow, PQ_IP_HSD_Y_Main);
        MDrv_Scl_PQ_LoadTable(eWindow, u16HSD_Y_idx, PQ_IP_HSD_Y_Main);

        u16HSD_C_idx = MDrv_Scl_PQ_GetTableIndex(eWindow, PQ_IP_HSD_C_Main);
        MDrv_Scl_PQ_LoadTable(eWindow, u16HSD_C_idx, PQ_IP_HSD_C_Main);
    ...
    switch(u32Flag)
    {
        case E_PQ_IOCTL_HSD_SAMPLING:
        {
            if(u32BufSize == sizeof(PQ_HSD_SAMPLING_INFO))
            {
                ...
                bret = _MDrv_Scl_PQ_Get_HSDSampling(eWindow, &u32ratio, &bADVMode);
        ...
        case E_PQ_IOCTL_ADC_SAMPLING:
            if(u32BufSize == sizeof(PQ_ADC_SAMPLING_INFO))
            {
                ...
                MS_PQ_ADC_SAMPLING_TYPE enADCSamplingType = MDrv_Scl_PQ_Get_ADCSampling_Info(eWindow, enInputSrc, pModeInfo);
        ...
        case E_PQ_IOCTL_RFBL_CTRL:
            //sclprintf("IOCTL %lx\r\n", u32Flag);
#if PQ_ENABLE_RFBL
            bret = MDrv_Scl_PQ_Get_RFBL_Info(eWindow);
#else
            bret = FALSE;
#endif
            UNUSED(pBuf);
...
MS_PQ_ADC_SAMPLING_TYPE MDrv_Scl_PQ_Get_ADCSampling_Info(PQ_WIN eWindow, PQ_INPUT_SOURCE_TYPE enInputSourceType, MS_PQ_Mode_Info *pstPQModeInfo)
{
    ...
    u16PQSrcType = _u16SclPQSrcType[eWindow];
    DrvSclOsMemcpy(&stModeInfo, &_stMode_Info[eWindow], sizeof(MS_PQ_Mode_Info));

    MDrv_Scl_PQ_Set_ModeInfo(eWindow, enInputSourceType, pstPQModeInfo);
    _u16SclPQSrcType[eWindow] = QM_InputSourceToIndex(eWindow, enInputSourceType);
    ...
    u16TableIdx = MDrv_Scl_PQ_GetTableIndex(eWindow, Hal_PQ_get_ip_idx(MS_PQ_IP_ADC_SAMPLING));
    ...
    DrvSclOsMemcpy(&_stMode_Info[eWindow], &stModeInfo, sizeof(MS_PQ_Mode_Info));
    _u16SclPQSrcType[eWindow] = u16PQSrcType;
...
void MDRV_PQ_PrintLoadTableInfo(MS_PQ_PQLOADTABLE_WIN enPQWin)
{
    ...
    {
        sclprintf(" %u(%s)=", u16IPIdx, MDrv_Scl_PQ_GetIPName(u16IPIdx));  // IP Name

        if(enPQWin == PQ_LOAD_TABLE_MAIN)
        {
            u8TabIdx = MDrv_Scl_PQ_Get_LoadTableInfo_IP_Tab(MAIN, u16IPIdx);
            if(u8TabIdx == 0xFF)
                sclprintf("_____\r\n");
            else
                sclprintf("%u(%s)\r\n", u8TabIdx, MDrv_Scl_PQ_GetTableName(u16IPIdx, u8TabIdx));
        }
        else if(enPQWin == PQ_LOAD_TABLE_MAIN_EX)
        {
            u8TabIdx = MDrv_Scl_PQ_Get_LoadTableInfo_IP_Tab(MAINEX, u16IPIdx);
            if(u8TabIdx == 0xFF)
                sclprintf("_____\r\n");
            else
                sclprintf("Tab%u\r\n", u8TabIdx);
        ...
        {
            u8TabIdx = MDrv_Scl_PQ_Get_LoadTableInfo_IP_Tab(SUB, u16IPIdx);
            if(u8TabIdx == 0xFF)
                sclprintf("_____\r\n");
            else
                sclprintf("%u(%s)\r\n", u8TabIdx, MDrv_Scl_PQ_GetTableName(u16IPIdx, u8TabIdx));
        ...
        {
            u8TabIdx = MDrv_Scl_PQ_Get_LoadTableInfo_IP_Tab(SUBEX, u16IPIdx);
            if(u8TabIdx == 0xFF)
                sclprintf("_____\r\n");
            else
                sclprintf("Tab%u\r\n", u8TabIdx);
        ...
        {
            u8TabIdx = MDrv_Scl_PQ_Get_LoadTableInfo_IP_Tab(SC1_MAIN, u16IPIdx);
            if(u8TabIdx == 0xFF)
                sclprintf("_____\r\n");
            else
                sclprintf("%u(%s)\r\n", u8TabIdx, MDrv_Scl_PQ_GetTableName(u16IPIdx, u8TabIdx));
        ...
        {
            u8TabIdx = MDrv_Scl_PQ_Get_LoadTableInfo_IP_Tab(SC1_MAINEX, u16IPIdx);
            if(u8TabIdx == 0xFF)
                sclprintf("_____\r\n");
            else
                sclprintf("Tab%u\r\n", u8TabIdx);
        ...
        {
            u8TabIdx = MDrv_Scl_PQ_Get_LoadTableInfo_IP_Tab(SC2_MAIN, u16IPIdx);
            if(u8TabIdx == 0xFF)
                sclprintf("_____\r\n");
            else
                sclprintf("%u(%s)\r\n", u8TabIdx, MDrv_Scl_PQ_GetTableName(u16IPIdx, u8TabIdx));
        ...
        {
            u8TabIdx = MDrv_Scl_PQ_Get_LoadTableInfo_IP_Tab(SC2_MAINEX, u16IPIdx);
            if(u8TabIdx == 0xFF)
                sclprintf("_____\r\n");
            else
                sclprintf("Tab%u\r\n", u8TabIdx);
        ...
        {
            u8TabIdx = MDrv_Scl_PQ_Get_LoadTableInfo_IP_Tab(SC2_SUB, u16IPIdx);
            if(u8TabIdx == 0xFF)
                sclprintf("_____\r\n");
            else
                sclprintf("%u(%s)\r\n", u8TabIdx, MDrv_Scl_PQ_GetTableName(u16IPIdx, u8TabIdx));
        ...
        {
            u8TabIdx = MDrv_Scl_PQ_Get_LoadTableInfo_IP_Tab(SC2_SUBEX, u16IPIdx);
            if(u8TabIdx == 0xFF)
                sclprintf("_____\r\n");
            else
                sclprintf("Tab%u\r\n", u8TabIdx);
...
//  PQ_WIN eWindow = (bIsMainWindow == TRUE) ? (PQ_MAIN_WINDOW):(PQ_SUB_WINDOW);
    ...
    u16TabIdx_MADi = MDrv_Scl_PQ_GetTableIndex(eWindow, PQ_IP_MADi_Main);
...
static void _MDrv_Scl_PQ_LoadPTPTable(PQ_WIN eWindow, u16 u16PQ_PTP_Idx)
{
    u16 i, u16IPIdx=0, u16TabIdx=0;
    ...
    {
        u16IPIdx = MDrv_Scl_PQ_GetGRule_IPIndex(eWindow, PQ_GRule_PTP_Main, i);

        if (u16PQ_PTP_Idx == PQ_GRULE_PTP_NUM_Main) // see it as default
            u16TabIdx = MDrv_Scl_PQ_GetTableIndex(eWindow, u16IPIdx);
        else
            u16TabIdx = MDrv_Scl_PQ_GetGRule_TableIndex(eWindow, PQ_GRule_PTP_Main, u16PQ_PTP_Idx, i);

        PQP2P_DBG(sclprintf("[PTP]SRC: %u, u16PQ_PTP_Idx: %u, PIPIPIdx:%u, IPIdx:%u, u8TabIdx:%u\r\n",
            _u16SclPQSrcType[eWindow], u16PQ_PTP_Idx, i, u16IPIdx, u16IPIdx);)
...
void MDrv_Scl_PQ_LoadPTPTable(PQ_WIN eWindow, PQ_PTP_FUNCTION_TYPE enPTP_Type)
{
    ...
    u16 u16PQ_PTPIdx;
     ...
     if( enPTP_Type == PQ_PTP_PTP )
     {
         ...
         u16PQ_PTPIdx = MDrv_Scl_PQ_GetGRule_LevelIndex(eWindow, PQ_GRule_PTP_Main, PQ_GRule_Lvl_PTP_On_Main);
         _MDrv_Scl_PQ_LoadPTPTable(eWindow, u16PQ_PTPIdx);
     }
     else
     {
         SCL_ASSERT(0);
                               ...
                               PQ_WIN eWindow)
{
    ...
    PQP2P_DBG(sclprintf("[MDrv_Scl_PQ_Set_PointToPoint] True or False: %u\r\n",bEnable);)
...
bool MDrv_Scl_PQ_Check_PointToPoint_Condition(XC_SETWIN_INFO *pstXC_SetWin_Info,PQ_WIN eWindow)
{
    ...
    PQP2P_DBG(sclprintf("[MDrv_Scl_PQ_Check_PointToPoint_Condition] %u\r\n",bRet);)
...
bool MDrv_Scl_PQ_LOW_3dQuality(bool bEnable)
{
    ...
    {
#if PQ_VIP_CTL
        MDrv_Scl_PQ_LoadTable(PQ_MAIN_WINDOW, PQ_IP_VIP_Peaking_band_AV_NTSC_Main, PQ_IP_VIP_Peaking_band_Main);
        MDrv_Scl_PQ_LoadTable(PQ_MAIN_WINDOW, PQ_IP_VIP_VNMR_S2_Main, PQ_IP_VIP_VNMR_Main);
        MDrv_Scl_PQ_LoadTable(PQ_MAIN_WINDOW, PQ_IP_VIP_VLPF_coef1_0x6_Main, PQ_IP_VIP_VLPF_coef1_Main);
#endif
    }
    else
    {
#if PQ_VIP_CTL
        MDrv_Scl_PQ_LoadTable(PQ_MAIN_WINDOW, MDrv_Scl_PQ_GetTableIndex(PQ_MAIN_WINDOW, PQ_IP_VIP_Peaking_band_Main), PQ_IP_VIP_Peaking_band_Main);
        MDrv_Scl_PQ_LoadTable(PQ_MAIN_WINDOW, MDrv_Scl_PQ_GetTableIndex(PQ_MAIN_WINDOW, PQ_IP_VIP_VNMR_Main), PQ_IP_VIP_VNMR_Main);
        MDrv_Scl_PQ_LoadTable(PQ_MAIN_WINDOW, MDrv_Scl_PQ_GetTableIndex(PQ_MAIN_WINDOW, PQ_IP_VIP_VLPF_coef1_Main), PQ_IP_VIP_VLPF_coef1_Main);
#endif
    }
    return TRUE;
}
...
bool MDrv_Scl_PQ_MWE_SetEnhanceQuality(void)
{
    ...
    MDrv_Scl_PQ_LoadTable(PQ_MAIN_WINDOW, PQ_IP_VIP_ICC_R_INC_3_Main, PQ_IP_VIP_ICC_R_Main);
    MDrv_Scl_PQ_LoadTable(PQ_MAIN_WINDOW, PQ_IP_VIP_ICC_G_INC_8_Main, PQ_IP_VIP_ICC_G_Main);
    MDrv_Scl_PQ_LoadTable(PQ_MAIN_WINDOW, PQ_IP_VIP_ICC_B_INC_6_Main, PQ_IP_VIP_ICC_B_Main);
    MDrv_Scl_PQ_LoadTable(PQ_MAIN_WINDOW, PQ_IP_VIP_ICC_C_INC_6_Main, PQ_IP_VIP_ICC_C_Main);
    MDrv_Scl_PQ_LoadTable(PQ_MAIN_WINDOW, PQ_IP_VIP_ICC_M_INC_6_Main, PQ_IP_VIP_ICC_M_Main);
    MDrv_Scl_PQ_LoadTable(PQ_MAIN_WINDOW, PQ_IP_VIP_ICC_Y_INC_7_Main, PQ_IP_VIP_ICC_Y_Main);
#endif
    return TRUE;
}
...
{
#if PQ_VIP_RGBCMY_CTL
    MDrv_Scl_PQ_LoadTable(PQ_MAIN_WINDOW, MDrv_Scl_PQ_GetTableIndex(PQ_MAIN_WINDOW, PQ_IP_VIP_ICC_R_Main), PQ_IP_VIP_ICC_R_Main);
    MDrv_Scl_PQ_LoadTable(PQ_MAIN_WINDOW, MDrv_Scl_PQ_GetTableIndex(PQ_MAIN_WINDOW, PQ_IP_VIP_ICC_G_Main), PQ_IP_VIP_ICC_G_Main);
    MDrv_Scl_PQ_LoadTable(PQ_MAIN_WINDOW, MDrv_Scl_PQ_GetTableIndex(PQ_MAIN_WINDOW, PQ_IP_VIP_ICC_B_Main), PQ_IP_VIP_ICC_B_Main);
    MDrv_Scl_PQ_LoadTable(PQ_MAIN_WINDOW, MDrv_Scl_PQ_GetTableIndex(PQ_MAIN_WINDOW, PQ_IP_VIP_ICC_C_Main), PQ_IP_VIP_ICC_C_Main);
    MDrv_Scl_PQ_LoadTable(PQ_MAIN_WINDOW, MDrv_Scl_PQ_GetTableIndex(PQ_MAIN_WINDOW, PQ_IP_VIP_ICC_M_Main), PQ_IP_VIP_ICC_M_Main);
    MDrv_Scl_PQ_LoadTable(PQ_MAIN_WINDOW, MDrv_Scl_PQ_GetTableIndex(PQ_MAIN_WINDOW, PQ_IP_VIP_ICC_Y_Main), PQ_IP_VIP_ICC_Y_Main);
#endif
    return TRUE;
}
...
{
#if PQ_VIP_CTL
    MDrv_Scl_PQ_LoadTable(PQ_MAIN_WINDOW, PQ_IP_VIP_ICC_ON_Main, PQ_IP_VIP_ICC_Main);
    MDrv_Scl_PQ_LoadTable(PQ_MAIN_WINDOW, PQ_IP_VIP_IBC_ON_Main, PQ_IP_VIP_IBC_Main);
    MDrv_Scl_PQ_LoadTable(PQ_MAIN_WINDOW, PQ_IP_VIP_IHC_ON_Main, PQ_IP_VIP_IHC_Main);
#endif
    return TRUE;
}
...
{
#if PQ_VIP_CTL
    MDrv_Scl_PQ_LoadTable(PQ_MAIN_WINDOW, PQ_IP_VIP_ICC_OFF_Main, PQ_IP_VIP_ICC_Main);
    MDrv_Scl_PQ_LoadTable(PQ_MAIN_WINDOW, PQ_IP_VIP_IBC_OFF_Main, PQ_IP_VIP_IBC_Main);
    MDrv_Scl_PQ_LoadTable(PQ_MAIN_WINDOW, PQ_IP_VIP_IHC_OFF_Main, PQ_IP_VIP_IHC_Main);
#endif
    return TRUE;
}
...
bool MDrv_Scl_PQ_Set_DisplayType_Sub(u16 u16DisplayWidth, PQ_DISPLAY_TYPE enDisplaType, bool bSkipCommTable)
{
    ...
    MDrv_Scl_PQ_AddTable_(SUB, &PQTableInfo);


    if(!bSkipCommTable)
    {
        MDrv_Scl_PQ_LoadCommTable_(SUB);
    }
    ...
    MDrv_Scl_PQ_AddTable_(SUBEX, &PQTableInfoEx);
    if(!bSkipCommTable)
    {
        MDrv_Scl_PQ_LoadCommTable_(SUBEX);
    }
...
bool MDrv_Scl_PQ_Set_DisplayType_SC1_Main(u16 u16DisplayWidth, PQ_DISPLAY_TYPE enDisplaType, bool bSkipCommTable)
{
    ...
    sclprintf("++++MDrv_Scl_PQ_Set_DisplayType_SC1_Main++++ \r\n");
    ...
    MDrv_Scl_PQ_AddTable_(SC1_MAIN, &PQTableInfo);
    if(!bSkipCommTable)
    {
        MDrv_Scl_PQ_LoadCommTable_(SC1_MAIN);
    }
    ...
    MDrv_Scl_PQ_AddTable_(SC1_MAINEX, &PQTableInfoEx);
    if(!bSkipCommTable)
    {
        MDrv_Scl_PQ_LoadCommTable_(SC1_MAINEX);
    }
...
bool MDrv_Scl_PQ_Set_DisplayType_SC2_Main(u16 u16DisplayWidth, PQ_DISPLAY_TYPE enDisplaType, bool bSkipCommTable)
{
    ...
    sclprintf("++++MDrv_Scl_PQ_Set_DisplayType_SC2_Main++++ \r\n");
    switch(enDisplaType)
    {
        default:
        case PQ_DISPLAY_ONE:
    ...
    MDrv_Scl_PQ_AddTable_(SC2_MAIN, &PQTableInfo);
    if(!bSkipCommTable)
    {
        MDrv_Scl_PQ_LoadCommTable_(SC2_MAIN);
    }
    ...
    MDrv_Scl_PQ_AddTable_(SC2_MAINEX, &PQTableInfoEx);
    if(!bSkipCommTable)
    {
        MDrv_Scl_PQ_LoadCommTable_(SC2_MAINEX);
    }
...
bool MDrv_Scl_PQ_Set_DisplayType_SC2_Sub(u16 u16DisplayWidth, PQ_DISPLAY_TYPE enDisplaType, bool bSkipCommTable)
{
    ...
    sclprintf("++++MDrv_Scl_PQ_Set_DisplayType_SC2_Sub++++ \r\n");
    // Load SC2_Sub PQ
    switch(enDisplaType)
    {
        default:
    ...
    MDrv_Scl_PQ_AddTable_(SC2_SUB, &PQTableInfo);


    if(!bSkipCommTable)
    {
        MDrv_Scl_PQ_LoadCommTable_(SC2_SUB);
    }
    ...
    MDrv_Scl_PQ_AddTable_(SC2_SUBEX, &PQTableInfoEx);
    if(!bSkipCommTable)
    {
        MDrv_Scl_PQ_LoadCommTable_(SC2_SUBEX);
    }
...
bool MDrv_Scl_PQ_GetMADiFromGrule(PQ_WIN eWindow, u16 *pu16TabIdx_MADi_Motion, u16 *pu16TabIdx_MADi)
{
    ...
    if(eWindow == PQ_MAIN_WINDOW)
    {
    #if PQ_GRULE_DDR_SELECT_ENABLE
        {
            ...
            {
                u16PQ_OSDBWIdx = MDrv_Scl_PQ_GetGRule_LevelIndex(eWindow, PQ_GRule_OSD_BW_Main, PQ_GRule_Lvl_OSD_BW_1DDR_On_Main);
                *pu16TabIdx_MADi = MDrv_Scl_PQ_GetGRule_TableIndex(eWindow, PQ_GRule_OSD_BW_Main, u16PQ_OSDBWIdx, 0); // only MADi ip
            }
            else // 2 DDR
            {
                u16PQ_OSDBWIdx = MDrv_Scl_PQ_GetGRule_LevelIndex(eWindow, PQ_GRule_OSD_BW_Main, PQ_GRule_Lvl_OSD_BW_2DDR_On_Main);
                *pu16TabIdx_MADi = MDrv_Scl_PQ_GetGRule_TableIndex(eWindow, PQ_GRule_OSD_BW_Main, u16PQ_OSDBWIdx, 0); // only MADi ip
            }
        }
    #else //DDR select disable
        {
            u16PQ_OSDBWIdx = MDrv_Scl_PQ_GetGRule_LevelIndex(eWindow, PQ_GRule_OSD_BW_Main, PQ_GRule_Lvl_OSD_BW_On_Main);
            *pu16TabIdx_MADi = MDrv_Scl_PQ_GetGRule_TableIndex(eWindow, PQ_GRule_OSD_BW_Main, u16PQ_OSDBWIdx, 0); // only MADi ip
        }
    #endif

    #if (PQ_GRULE_OSD_BW_IP_NUM_Main > 1)
        *pu16TabIdx_MADi_Motion = MDrv_Scl_PQ_GetGRule_TableIndex(eWindow, PQ_GRule_OSD_BW_Main, u16PQ_OSDBWIdx, 1); // Add MADi_Motion ip
    #else
    ...
    else if(eWindow == PQ_SC1_MAIN_WINDOW)
    {
    #if PQ_GRULE_DDR_SELECT_ENABLE
        {
            if(bw_info.u32Miu1MemSize ==0) // 1 DDR
            {
                u16PQ_OSDBWIdx = MDrv_Scl_PQ_GetGRule_LevelIndex(eWindow, PQ_GRule_OSD_BW_SC1_Main, PQ_GRule_Lvl_OSD_BW_1DDR_On_SC1_Main);
                *pu16TabIdx_MADi = MDrv_Scl_PQ_GetGRule_TableIndex(eWindow, PQ_GRule_OSD_BW_SC1_Main, u16PQ_OSDBWIdx, 0); // only MADi ip
            }
            else // 2 DDR
            {
                u16PQ_OSDBWIdx = MDrv_Scl_PQ_GetGRule_LevelIndex(eWindow, PQ_GRule_OSD_BW_SC1_Main, PQ_GRule_Lvl_OSD_BW_2DDR_On_SC1_Main);
                *pu16TabIdx_MADi = MDrv_Scl_PQ_GetGRule_TableIndex(eWindow, PQ_GRule_OSD_BW_SC1_Main, u16PQ_OSDBWIdx, 0); // only MADi ip
            }
        }
    #else //DDR select disable
        {
            u16PQ_OSDBWIdx = MDrv_Scl_PQ_GetGRule_LevelIndex(eWindow, PQ_GRule_OSD_BW_SC1_Main, PQ_GRule_Lvl_OSD_BW_On_SC1_Main);
            *pu16TabIdx_MADi = MDrv_Scl_PQ_GetGRule_TableIndex(eWindow, PQ_GRule_OSD_BW_SC1_Main, u16PQ_OSDBWIdx, 0); // only MADi ip
        }
    #endif

    #if (PQ_GRULE_OSD_BW_IP_NUM_SC1_Main > 1)
        *pu16TabIdx_MADi_Motion = MDrv_Scl_PQ_GetGRule_TableIndex(eWindow, PQ_GRule_OSD_BW_SC1_Main, u16PQ_OSDBWIdx, 1); // Add MADi_Motion ip
    #else
        UNUSED(pu16TabIdx_MADi_Motion);
    #endif
    }
    else if(eWindow == PQ_SC2_MAIN_WINDOW)
    {
    #if PQ_GRULE_DDR_SELECT_ENABLE
        {
            if(bw_info.u32Miu1MemSize ==0) // 1 DDR
            {
                u16PQ_OSDBWIdx = MDrv_Scl_PQ_GetGRule_LevelIndex(eWindow, PQ_GRule_OSD_BW_SC2_Main, PQ_GRule_Lvl_OSD_BW_1DDR_On_SC1_Main);
                *pu16TabIdx_MADi = MDrv_Scl_PQ_GetGRule_TableIndex(eWindow, PQ_GRule_OSD_BW_SC2_Main, u16PQ_OSDBWIdx, 0); // only MADi ip
            }
            else // 2 DDR
            {
                u16PQ_OSDBWIdx = MDrv_Scl_PQ_GetGRule_LevelIndex(eWindow, PQ_GRule_OSD_BW_SC2_Main, PQ_GRule_Lvl_OSD_BW_2DDR_On_SC2_Main);
                *pu16TabIdx_MADi = MDrv_Scl_PQ_GetGRule_TableIndex(eWindow, PQ_GRule_OSD_BW_SC2_Main, u16PQ_OSDBWIdx, 0); // only MADi ip
            }
        }
    #else //DDR select disable
        {
            u16PQ_OSDBWIdx = MDrv_Scl_PQ_GetGRule_LevelIndex(eWindow, PQ_GRule_OSD_BW_SC2_Main, PQ_GRule_Lvl_OSD_BW_On_SC2_Main);
            *pu16TabIdx_MADi = MDrv_Scl_PQ_GetGRule_TableIndex(eWindow, PQ_GRule_OSD_BW_SC2_Main, u16PQ_OSDBWIdx, 0); // only MADi ip
        }
    #endif

    #if (PQ_GRULE_OSD_BW_IP_NUM_SC2_Main > 1)
        *pu16TabIdx_MADi_Motion = MDrv_Scl_PQ_GetGRule_TableIndex(eWindow, PQ_GRule_OSD_BW_SC2_Main, u16PQ_OSDBWIdx, 1); // Add MADi_Motion ip
    #else
        UNUSED(pu16TabIdx_MADi_Motion);
    #endif
    }
                                            ...
                                            )
{
    ...
    if(bMemFmt422)
    {
        if(eWindow == PQ_MAIN_WINDOW)
        {
            *pu16TabIdx_MemFormat = MDrv_Scl_PQ_GetTableIndex(eWindow, PQ_IP_MemFormat_Main);
        ...
        {
            *pu16TabIdx_MemFormat = MDrv_Scl_PQ_GetTableIndex(eWindow, PQ_IP_MemFormat_Sub);
        ...
        {
            *pu16TabIdx_MemFormat = MDrv_Scl_PQ_GetTableIndex(eWindow, PQ_IP_MemFormat_SC1_Main);
            *pu16TabIdx_444To422 = PQ_IP_444To422_ON_SC1_Main;
            *pu16TabIdx_422To444 = Hal_PQ_get_422To444_idx((MS_422To444_TYPE)Hal_PQ_get_422To444_mode(bMemFmt422));
        }
        else if(eWindow == PQ_SC2_MAIN_WINDOW)
        {
            *pu16TabIdx_MemFormat = MDrv_Scl_PQ_GetTableIndex(eWindow, PQ_IP_MemFormat_SC2_Main);
        ...
        {
            *pu16TabIdx_MemFormat = MDrv_Scl_PQ_GetTableIndex(eWindow, PQ_IP_MemFormat_SC2_Sub);
            *pu16TabIdx_444To422 = PQ_IP_444To422_ON_Sub;
            *pu16TabIdx_422To444 = Hal_PQ_get_422To444_idx((MS_422To444_TYPE)Hal_PQ_get_422To444_mode(bMemFmt422));
        }
#endif
...
bool MDrv_Scl_PQ_GetMADiInGeneral(PQ_WIN eWindow, u16 *pu16TabIdx_MADi_Motion, u16 *pu16TabIdx_MADi)
{
    ...
    if(eWindow == PQ_MAIN_WINDOW)
    {
         ...
         if(bw_info.u32Miu1MemSize==0) // 1 DDR
         {
              u16PQ_DDRSELIdx = MDrv_Scl_PQ_GetGRule_LevelIndex(eWindow, PQ_GRule_DDR_SELECT_Main, PQ_GRule_Lvl_DDR_SELECT_1DDR_Main);
              *pu16TabIdx_MADi = MDrv_Scl_PQ_GetGRule_TableIndex(eWindow, PQ_GRule_DDR_SELECT_Main, u16PQ_DDRSELIdx, 0); // only MADi ip
         }
         else // 2 DDR
         {
              u16PQ_DDRSELIdx = MDrv_Scl_PQ_GetGRule_LevelIndex(eWindow, PQ_GRule_DDR_SELECT_Main, PQ_GRule_Lvl_DDR_SELECT_2DDR_Main);
              *pu16TabIdx_MADi = MDrv_Scl_PQ_GetGRule_TableIndex(eWindow, PQ_GRule_DDR_SELECT_Main, u16PQ_DDRSELIdx, 0); // only MADi ip
         }
    }
    else if(eWindow == PQ_SUB_WINDOW)
    {
         *pu16TabIdx_MADi = MDrv_Scl_PQ_GetTableIndex(eWindow, PQ_IP_MADi_Sub);
    }
    ...
    else if(eWindow == PQ_SC1_MAIN_WINDOW)
    {
         ...
         if(bw_info.u32Miu1MemSize==0) // 1 DDR
         {
              u16PQ_DDRSELIdx = MDrv_Scl_PQ_GetGRule_LevelIndex(eWindow, PQ_GRule_DDR_SELECT_SC1_Main, PQ_GRule_Lvl_DDR_SELECT_1DDR_SC1_Main);
              *pu16TabIdx_MADi = MDrv_Scl_PQ_GetGRule_TableIndex(eWindow, PQ_GRule_DDR_SELECT_SC1_Main, u16PQ_DDRSELIdx, 0); // only MADi ip
         }
         else // 2 DDR
         {
              u16PQ_DDRSELIdx = MDrv_Scl_PQ_GetGRule_LevelIndex(eWindow, PQ_GRule_DDR_SELECT_SC1_Main, PQ_GRule_Lvl_DDR_SELECT_2DDR_SC1_Main);
              *pu16TabIdx_MADi = MDrv_Scl_PQ_GetGRule_TableIndex(eWindow, PQ_GRule_DDR_SELECT_SC1_Main, u16PQ_DDRSELIdx, 0); // only MADi ip
         }
    }
    else if(eWindow == PQ_SC2_MAIN_WINDOW)
    {
         ...
         if(bw_info.u32Miu1MemSize==0) // 1 DDR
         {
              u16PQ_DDRSELIdx = MDrv_Scl_PQ_GetGRule_LevelIndex(eWindow, PQ_GRule_DDR_SELECT_SC2_Main, PQ_GRule_Lvl_DDR_SELECT_1DDR_SC2_Main);
              *pu16TabIdx_MADi = MDrv_Scl_PQ_GetGRule_TableIndex(eWindow, PQ_GRule_DDR_SELECT_SC2_Main, u16PQ_DDRSELIdx, 0); // only MADi ip
         }
         else // 2 DDR
         {
              u16PQ_DDRSELIdx = MDrv_Scl_PQ_GetGRule_LevelIndex(eWindow, PQ_GRule_DDR_SELECT_SC2_Main, PQ_GRule_Lvl_DDR_SELECT_2DDR_SC2_Main);
              *pu16TabIdx_MADi = MDrv_Scl_PQ_GetGRule_TableIndex(eWindow, PQ_GRule_DDR_SELECT_SC2_Main, u16PQ_DDRSELIdx, 0); // only MADi ip
         }
    }
    else if(eWindow == PQ_SC2_SUB_WINDOW)
    {
         *pu16TabIdx_MADi = MDrv_Scl_PQ_GetTableIndex(eWindow, PQ_IP_MADi_SC2_Sub);
    }
#endif // ENABLE_MULTI_SCALER
#else //DDR select disable
    {
        if(eWindow == PQ_MAIN_WINDOW)
        {
            *pu16TabIdx_MADi = MDrv_Scl_PQ_GetTableIndex(eWindow, PQ_IP_MADi_Main);
        }
#if PQ_ENABLE_PIP
        else if(eWindow == PQ_SUB_WINDOW)
        {
        ...
        {
            *pu16TabIdx_MADi = MDrv_Scl_PQ_GetTableIndex(eWindow, PQ_IP_MADi_SC1_Main);
        }
        else if(eWindow == PQ_SC2_MAIN_WINDOW)
        {
            *pu16TabIdx_MADi = MDrv_Scl_PQ_GetTableIndex(eWindow, PQ_IP_MADi_SC2_Main);
        }
#if PQ_ENABLE_PIP
        else if(eWindow == PQ_SC2_SUB_WINDOW)
        {
        ...
        *pu16TabIdx_MADi = Hal_PQ_get_madi_idx(eWindow, (MS_MADI_TYPE)_stRFBL_Info.u8MADiType);
        if(!_stMode_Info[eWindow].bInterlace)
        {
            *pu16TabIdx_MADi = Hal_PQ_get_madi_idx(eWindow, MS_MADI_P_MODE8_NO_MIU);
            ...
            MDrv_Scl_PQ_MADiForceMotionY(eWindow, FALSE);
            MDrv_Scl_PQ_MADiForceMotionC(eWindow, FALSE);
...
bool MDrv_Scl_PQ_Patch2Rto4RForFieldPackingMode(PQ_WIN eWindow, u16 u16TabIdx_MADi)
{
    ...
    if(eWindow == PQ_MAIN_WINDOW)
    {
        ...
        ))
        {
            ...
            //delay
            _MDrv_Scl_PQ_wait_output_vsync(eWindow, 1, 90);
        }
    }
...
#endif
#if PQ_UC_CTL
            MDrv_Scl_PQ_LoadTable(eWindow, PQ_IP_UC_CTL_OFF_Main, PQ_IP_UC_CTL_Main);
#endif
#if(ENABLE_PQ_MLOAD)
            MDrv_Scl_PQ_Set_MLoadEn(eWindow, FALSE);
#endif
                                            ...
                                            )
{
    ...
    if(eWindow == PQ_MAIN_WINDOW)
    {
        ...
        if(MApi_XC_Get_3D_HW_Version() < 2)
        {
            ...
            {
                MDrv_Scl_PQ_EnableMADIForce(PQ_MAIN_WINDOW, TRUE);
#if PQ_MADI_DFK
                MDrv_Scl_PQ_LoadTable(eWindow, PQ_IP_MADi_DFK_OFF_Main, PQ_IP_MADi_DFK_Main);
#endif
                MDrv_Scl_PQ_LoadTable(eWindow, PQ_IP_EODi_OFF_Main, PQ_IP_EODi_Main);
            }
            //line by line must use weave mode
            else if(E_XC_3D_OUTPUT_LINE_ALTERNATIVE == MApi_XC_Get_3D_Output_Mode())
            {
                MDrv_Scl_PQ_EnableMADIForce(eWindow, FALSE);
            }
...
static bool _MDrv_Scl_PQ_Get_Picture_3x3_Matrix(PQ_WIN eWindow, u16 *pBuf)
{
    u16 u16TableIdx;
    bool bret;
    u16TableIdx = MDrv_Scl_PQ_GetTableIndex(eWindow, PQ_IP_SRAM_3x3matrix_PIC2_Main);
...
#endif
    {
        if(eWindow == PQ_MAIN_WINDOW)
        {
            bret = MDrv_Scl_PQ_LoadPictureSetting_(MAIN, (u8)u16TableIdx, PQ_IP_SRAM_3x3matrix_PIC2_Main, (void *)pBuf, PQ_IP_SRAM_3x3matrix_PIC2_SIZE_Main);
        }
    #if PQ_ENABLE_PIP
        else if(eWindow == PQ_SUB_WINDOW)
        {
            bret = MDrv_Scl_PQ_LoadPictureSetting_(SUB, (u8)u16TableIdx, PQ_IP_SRAM_3x3matrix_PIC2_Sub, (void *)pBuf, PQ_IP_SRAM_3x3matrix_PIC2_SIZE_Sub);
        }
    #endif
    #if ENABLE_MULTI_SCALER
        else if(eWindow == PQ_SC1_MAIN_WINDOW)
        {
            bret = MDrv_Scl_PQ_LoadPictureSetting_(SC1_MAIN, (u8)u16TableIdx, PQ_IP_SRAM_3x3matrix_PIC2_SC1_Main, (void *)pBuf, PQ_IP_SRAM_3x3matrix_PIC2_SIZE_SC1_Main);
        }
        else if(eWindow == PQ_SC2_MAIN_WINDOW)
        {
            bret = MDrv_Scl_PQ_LoadPictureSetting_(SC2_MAIN, (u8)u16TableIdx, PQ_IP_SRAM_3x3matrix_PIC2_SC2_Main, (void *)pBuf, PQ_IP_SRAM_3x3matrix_PIC2_SIZE_SC2_Main);
        }
        else if(eWindow == PQ_SC2_SUB_WINDOW)
        {
            bret = MDrv_Scl_PQ_LoadPictureSetting_(SC2_SUB, (u8)u16TableIdx, PQ_IP_SRAM_3x3matrix_PIC2_SC2_Sub, (void *)pBuf, PQ_IP_SRAM_3x3matrix_PIC2_SIZE_SC2_Sub);
        }
    #endif
        else
        {
...
static bool _MDrv_Scl_PQ_Get_Picture_DLC(PQ_WIN eWindow, u16 *pBuf)
{
    u16 u16TableIdx;
    bool bret = TRUE;

    u16TableIdx = MDrv_Scl_PQ_GetTableIndex(eWindow, PQ_IP_SRAM_DLC_PIC1_Main);
...
#endif
    {
        if(eWindow == PQ_MAIN_WINDOW)
        {
            bret = MDrv_Scl_PQ_LoadPictureSetting_(MAIN, (u8)u16TableIdx, PQ_IP_SRAM_DLC_PIC1_Main, (void *)pBuf, PQ_IP_SRAM_DLC_PIC1_SIZE_Main);
        }
    #if PQ_ENABLE_PIP
        else if(eWindow == PQ_SUB_WINDOW)
        {
            bret = MDrv_Scl_PQ_LoadPictureSetting_(SUB, (u8)u16TableIdx, PQ_IP_SRAM_DLC_PIC1_Sub, (void *)pBuf, PQ_IP_SRAM_DLC_PIC1_SIZE_Sub);
        }
    #endif
    #if ENABLE_MULTI_SCALER
        else if(eWindow == PQ_SC1_MAIN_WINDOW)
        {
            bret = MDrv_Scl_PQ_LoadPictureSetting_(SC1_MAIN, (u8)u16TableIdx, PQ_IP_SRAM_DLC_PIC1_SC1_Main, (void *)pBuf, PQ_IP_SRAM_DLC_PIC1_SIZE_SC1_Main);
        }
        else if(eWindow == PQ_SC2_MAIN_WINDOW)
        {
            bret = MDrv_Scl_PQ_LoadPictureSetting_(SC2_MAIN, (u8)u16TableIdx, PQ_IP_SRAM_DLC_PIC1_SC2_Main, (void *)pBuf, PQ_IP_SRAM_DLC_PIC1_SIZE_SC2_Main);
        }
        else if(eWindow == PQ_SC2_SUB_WINDOW)
        {
            bret = MDrv_Scl_PQ_LoadPictureSetting_(SC2_SUB, (u8)u16TableIdx, PQ_IP_SRAM_DLC_PIC1_SC2_Sub, (void *)pBuf, PQ_IP_SRAM_DLC_PIC1_SIZE_SC2_Sub);
        }
    #endif
        else
        {
...
static bool _MDrv_Scl_PQ_Get_Picture_ColorSetting(PQ_WIN eWindow, u16 *pBuf)
{
    u16 u16TableIdx;
    bool bret = TRUE;

    u16TableIdx = MDrv_Scl_PQ_GetTableIndex(eWindow, PQ_IP_SRAM_Bri_Con_Hue_Sat_Sha_PIC1_Main);
...
#endif
    {
        if(eWindow == PQ_MAIN_WINDOW)
        {
            bret = MDrv_Scl_PQ_LoadPictureSetting_(MAIN, (u8)u16TableIdx, PQ_IP_SRAM_Bri_Con_Hue_Sat_Sha_PIC1_Main, (void *)pBuf, PQ_IP_SRAM_Bri_Con_Hue_Sat_Sha_PIC1_SIZE_Main);
        }
    #if PQ_ENABLE_PIP
        else if(eWindow == PQ_SUB_WINDOW)
        {
            bret = MDrv_Scl_PQ_LoadPictureSetting_(SUB, (u8)u16TableIdx, PQ_IP_SRAM_Bri_Con_Hue_Sat_Sha_PIC1_Sub, (void *)pBuf, PQ_IP_SRAM_Bri_Con_Hue_Sat_Sha_PIC1_SIZE_Sub);
        }
    #endif
    #if ENABLE_MULTI_SCALER
        else if(eWindow == PQ_SC1_MAIN_WINDOW)
        {
            bret = MDrv_Scl_PQ_LoadPictureSetting_(SC1_MAIN, (u8)u16TableIdx, PQ_IP_SRAM_Bri_Con_Hue_Sat_Sha_PIC1_SC1_Main, (void *)pBuf, PQ_IP_SRAM_Bri_Con_Hue_Sat_Sha_PIC1_SIZE_SC1_Main);
        }
        else if(eWindow == PQ_SC2_MAIN_WINDOW)
        {
            bret = MDrv_Scl_PQ_LoadPictureSetting_(SC2_MAIN, (u8)u16TableIdx, PQ_IP_SRAM_Bri_Con_Hue_Sat_Sha_PIC1_SC2_Main, (void *)pBuf, PQ_IP_SRAM_Bri_Con_Hue_Sat_Sha_PIC1_SIZE_SC2_Main);
        }
        else if(eWindow == PQ_SC2_SUB_WINDOW)
        {
            bret = MDrv_Scl_PQ_LoadPictureSetting_(SC2_SUB, (u8)u16TableIdx, PQ_IP_SRAM_Bri_Con_Hue_Sat_Sha_PIC1_SC2_Sub, (void *)pBuf, PQ_IP_SRAM_Bri_Con_Hue_Sat_Sha_PIC1_SIZE_SC2_Sub);
        }
    #endif
        else
        {
...
static bool _MDrv_Scl_PQ_Get_Picture_Gamma_TBL(PQ_WIN eWindow, u16 *pBuf, PQ_PICTURE_TYPE enPictureType)
{
    u16 u16TableIdx;
    bool bret = TRUE;
    u16 u16PQIdx, u16Tabsize;

    u16TableIdx = enPictureType == E_PQ_PICTURE_GAMMA_TBL_R ? MDrv_Scl_PQ_GetTableIndex(eWindow, PQ_IP_SRAM_GammaTbl_R_PIC1_Main) :
                  enPictureType == E_PQ_PICTURE_GAMMA_TBL_G ? MDrv_Scl_PQ_GetTableIndex(eWindow, PQ_IP_SRAM_GammaTbl_G_PIC1_Main) :
                                                              MDrv_Scl_PQ_GetTableIndex(eWindow, PQ_IP_SRAM_GammaTbl_B_PIC1_Main);
...
#endif
    {
        ...
        if(eWindow == PQ_MAIN_WINDOW)
        {
            bret = MDrv_Scl_PQ_LoadPictureSetting_(MAIN, (u8)u16TableIdx, (u8)u16PQIdx, (void *)pBuf, u16Tabsize);
        }
    #if PQ_ENABLE_PIP
        else if(eWindow == PQ_SUB_WINDOW)
        {
            bret = MDrv_Scl_PQ_LoadPictureSetting_(SUB, (u8)u16TableIdx, (u8)u16PQIdx, (void *)pBuf, u16Tabsize);
        }
    #endif
    #if ENABLE_MULTI_SCALER
        else if(eWindow == PQ_SC1_MAIN_WINDOW)
        {
            bret = MDrv_Scl_PQ_LoadPictureSetting_(SC1_MAIN, (u8)u16TableIdx, (u8)u16PQIdx, (void *)pBuf, u16Tabsize);
        }
        else if(eWindow == PQ_SC2_MAIN_WINDOW)
        {
            bret = MDrv_Scl_PQ_LoadPictureSetting_(SC2_MAIN, (u8)u16TableIdx, (u8)u16PQIdx, (void *)pBuf, u16Tabsize);
        }
        else if(eWindow == PQ_SC2_SUB_WINDOW)
        {
            bret = MDrv_Scl_PQ_LoadPictureSetting_(SC2_SUB, (u8)u16TableIdx, (u8)u16PQIdx, (void *)pBuf, u16Tabsize);
        }
    #endif
        else
        {
...
static bool _MDrv_Scl_PQ_Get_Picture_AutoColor(PQ_WIN eWindow, u16 *pBuf)
{
    u16 u16TableIdx;
    bool bret = TRUE;

    u16TableIdx = MDrv_Scl_PQ_GetTableIndex(eWindow, PQ_IP_SRAM_Auto_Color_PIC2_Main);
...
#endif
    {
        ...
        if(eWindow == PQ_MAIN_WINDOW)
        {
            bret = MDrv_Scl_PQ_LoadPictureSetting_(MAIN, (u8)u16TableIdx, PQ_IP_SRAM_Auto_Color_PIC2_Main, (void *)pBuf, PQ_IP_SRAM_Auto_Color_PIC2_SIZE_Main);
        }
    #if PQ_ENABLE_PIP
        else if(eWindow == PQ_SUB_WINDOW)
        {
            bret = MDrv_Scl_PQ_LoadPictureSetting_(SUB, (u8)u16TableIdx, PQ_IP_SRAM_Auto_Color_PIC2_Sub, (void *)pBuf, PQ_IP_SRAM_Auto_Color_PIC2_SIZE_Sub);
        }
    #endif
    #if ENABLE_MULTI_SCALER
        else if(eWindow == PQ_SC1_MAIN_WINDOW)
        {
            bret = MDrv_Scl_PQ_LoadPictureSetting_(SC1_MAIN, (u8)u16TableIdx, PQ_IP_SRAM_Auto_Color_PIC2_SC1_Main, (void *)pBuf, PQ_IP_SRAM_Auto_Color_PIC2_SIZE_SC1_Main);
        }
        else if(eWindow == PQ_SC2_MAIN_WINDOW)
        {
            bret = MDrv_Scl_PQ_LoadPictureSetting_(SC2_MAIN, (u8)u16TableIdx, PQ_IP_SRAM_Auto_Color_PIC2_SC2_Main, (void *)pBuf, PQ_IP_SRAM_Auto_Color_PIC2_SIZE_SC2_Main);
        }
        else if(eWindow == PQ_SC2_SUB_WINDOW)
        {
            bret = MDrv_Scl_PQ_LoadPictureSetting_(SC2_SUB, (u8)u16TableIdx, PQ_IP_SRAM_Auto_Color_PIC2_SC2_Sub, (void *)pBuf, PQ_IP_SRAM_Auto_Color_PIC2_SIZE_SC2_Sub);
        }
    #endif
        else
        {
...
static bool _MDrv_Scl_PQ_Get_Picture_ColorTemp(PQ_WIN eWindow, u16 *pBuf)
{
    u16 u16TableIdx;
    bool bret = TRUE;


    u16TableIdx = MDrv_Scl_PQ_GetTableIndex(eWindow, PQ_IP_SRAM_Color_Temp_PIC1_Main);
...
#endif
    {
        ...
        if(eWindow == PQ_MAIN_WINDOW)
        {
            bret = MDrv_Scl_PQ_LoadPictureSetting_(MAIN, (u8)u16TableIdx, PQ_IP_SRAM_Color_Temp_PIC1_Main, (void *)pBuf, PQ_IP_SRAM_Color_Temp_PIC1_SIZE_Main);
        }
#if PQ_ENABLE_PIP
        else if(eWindow == PQ_SUB_WINDOW)
        {
            bret = MDrv_Scl_PQ_LoadPictureSetting_(SUB, (u8)u16TableIdx, PQ_IP_SRAM_Color_Temp_PIC1_Sub, (void *)pBuf, PQ_IP_SRAM_Color_Temp_PIC1_SIZE_Sub);
        }
#endif
#if ENABLE_MULTI_SCALER
        else if(eWindow == PQ_SC1_MAIN_WINDOW)
        {
            bret = MDrv_Scl_PQ_LoadPictureSetting_(SC1_MAIN, (u8)u16TableIdx, PQ_IP_SRAM_Color_Temp_PIC1_SC1_Main, (void *)pBuf, PQ_IP_SRAM_Color_Temp_PIC1_SIZE_SC1_Main);
        }
        else if(eWindow == PQ_SC2_MAIN_WINDOW)
        {
            bret = MDrv_Scl_PQ_LoadPictureSetting_(SC2_MAIN, (u8)u16TableIdx, PQ_IP_SRAM_Color_Temp_PIC1_SC2_Main, (void *)pBuf, PQ_IP_SRAM_Color_Temp_PIC1_SIZE_SC2_Main);
        }
        else if(eWindow == PQ_SC2_SUB_WINDOW)
        {
            bret = MDrv_Scl_PQ_LoadPictureSetting_(SC2_SUB, (u8)u16TableIdx, PQ_IP_SRAM_Color_Temp_PIC1_SC2_Sub, (void *)pBuf, PQ_IP_SRAM_Color_Temp_PIC1_SIZE_SC2_Sub);
        }
#endif
        else
        {
...
bool MDrv_Scl_PQ_Get_Sharpness(PQ_WIN eWindow, PQ_INPUT_SOURCE_TYPE enInputSourceType, MS_PQ_Mode_Info * pstPQModeInfo, u8 *pu8Sharpness)
{
    ...
    {
        u16PQSrcType = _u16SclPQSrcType[eWindow];
        _u16SclPQSrcType[eWindow] = QM_AV_PAL_M_Main;
    }
    ...
    {
        MDrv_Scl_PQ_LoadTableData(eWindow, u16TableIdx, u16IPIdx, u8Peaking_Gain, 1);
...
bool MDrv_Scl_PQ_Get_Picture(PQ_WIN eWindow, PQ_INPUT_SOURCE_TYPE enInputSourceType, MS_PQ_Mode_Info * pstPQModeInfo, PQ_PICTURE_TYPE enType, void *pBuf)
{
    ...
    PQCOLOR_DBG(sclprintf("PQ_Get_Picture: Type:%d  SRC:%d \n", enType, _u16SclPQSrcType[eWindow]));

    switch(enType)
    {
    case E_PQ_PICTURE_3x3_MATRIX:
        bret = _MDrv_Scl_PQ_Get_Picture_3x3_Matrix(eWindow, pBuf);
        break;

    case E_PQ_PICTURE_DLC_CURVE:
        bret = _MDrv_Scl_PQ_Get_Picture_DLC(eWindow, pBuf);
        break;

    case E_PQ_PICTURE_COLOR_SETTING:
        bret = _MDrv_Scl_PQ_Get_Picture_ColorSetting(eWindow, pBuf);
        break;

    case E_PQ_PICTURE_GAMMA_TBL_R:
    case E_PQ_PICTURE_GAMMA_TBL_G:
    case E_PQ_PICTURE_GAMMA_TBL_B:
        bret = _MDrv_Scl_PQ_Get_Picture_Gamma_TBL(eWindow, pBuf, enType);
        break;

    case E_PQ_PICTURE_AUTO_COLOR:
        bret = _MDrv_Scl_PQ_Get_Picture_AutoColor(eWindow, pBuf);
        break;


    case E_PQ_PICTURE_COLOR_TEMP:
        bret = _MDrv_Scl_PQ_Get_Picture_ColorTemp(eWindow, pBuf);
        break;
    }
