...
DEPS:=vpe
MACROS:=SCLOS_TYPE_LINUX_KERNEL SCLOS_TYPE_LINUX_KERNEL_I2

DRV_PUB_INCS:=MI_HAL/pub/mhal_vpe.h
DRV_INC_PATH:=scl/inc/linux scl/inc/pq scl/pub/ scl/pub/linux MI_HAL/pub MI_HAL/inc ../hal/scl/inc/drv/linux ../../cmdq_service/drv/pub ../../../include/common
