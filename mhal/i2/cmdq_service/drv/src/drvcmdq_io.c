    ...
    switch(u32Cmd)
    {
        ...
        case IOCTL_CMDQ_TEST_1:
            ...
            else if(nTstArg == 13)//menuload mode test
            {
                ...
                gpCmdqInterface[u32SelectCmdq]->MHAL_CMDQ_GetNextMlodRignBufWritePtr(gpCmdqInterface[u32SelectCmdq], &wphyaddr[0]);
                ...
                gpCmdqInterface[u32SelectCmdq]->MHAL_CMDQ_GetNextMlodRignBufWritePtr(gpCmdqInterface[u32SelectCmdq], &wphyaddr[1]);
                ...
                gpCmdqInterface[u32SelectCmdq]->MHAL_CMDQ_GetNextMlodRignBufWritePtr(gpCmdqInterface[u32SelectCmdq], &wphyaddr[2]);
                ...
                gpCmdqInterface[u32SelectCmdq]->MHAL_CMDQ_GetNextMlodRignBufWritePtr(gpCmdqInterface[u32SelectCmdq], &wphyaddr[3]);
            ...
            else if(nTstArg == 14)//menuload mode test wait buffer
            {
                ...
                //gpCmdqInterface->MHAL_CMDQ_GetNextMlodRignBufWritePtr(gpCmdqInterface,&wphyaddr[3]);
