...
log "\n\n${script}: Test Encoder feature SEI\n"
...
if true; then
  ...
  run_case sei1
  test "Check ${of} md5" `expr "${md5}" == "9ecd3b81fa0814040962557eb88ddd5d"`
fi
...
if true; then
  export VENC_GLOB_USER_DATA=""
  run_case sei0
  test "Check ${of} md5" `expr "${md5}" == "eff57efaded3da9fa50020bcf6d71348"`
fi

if true; then
  export VENC_GLOB_USER_DATA="I have a pen."
  run_case sei1
  test "Check ${of} md5" `expr "${md5}" == "0c88849ff19cac3fd083e5ea1e97f795"`
fi
