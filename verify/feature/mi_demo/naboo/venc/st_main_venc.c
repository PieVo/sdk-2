...
{
    {
        .stDesc =
        {
            .szDesc = "1x4K(3840x2176)@25 H264 Encode",
            .u32VencNum = 1,
        },
        .stCaseArgs =
        {
    ...
    },
    {
        .stDesc =
        {
            .szDesc = "1x4K(3840x2176)@25 H265 Encode",
            .u32VencNum = 1,
        },
        .stCaseArgs =
        {
    ...
    },
    {
        .stDesc =
        {
            .szDesc = "1x1080P(1920x1088)@25 H264 Encode",
            .u32VencNum = 1,
        },
        .stCaseArgs =
        {
    ...
    },
    {
        .stDesc =
        {
            .szDesc = "1x1080P(1920x1088)@25 H265 Encode",
            .u32VencNum = 1,
        },
        .stCaseArgs =
        {
    ...
    },
    {
        .stDesc =
        {
            .szDesc = "2x1080P(1920x1088)@25 H264 Encode",
            .u32VencNum = 2,
        },
        .stCaseArgs =
        {
    ...
    },
    {
        .stDesc =
        {
            .szDesc = "4x1080P(1920x1088)@25 H264 Encode",
            .u32VencNum = 4,
        },
        .stCaseArgs =
        {
    ...
    },
    {
        .stDesc =
        {
            .szDesc = "4x1080P(1920x1088)@25 H265 Encode",
            .u32VencNum = 4,
        },
        .stCaseArgs =
        {
    ...
    },
    {
        .stDesc =
        {
            .szDesc = "1xD1(736x576)@25 H265 Encode",
            .u32VencNum = 1,
        },
        .stCaseArgs =
        {
    ...
    },
    {
        .stDesc =
        {
            .szDesc = "16xD1(736x576)@25 H265 Encode",
            .u32VencNum = 16,
        },
        .stCaseArgs =
        {
...
void *ST_VencFillYUVProc(void *args)
{
    ...
    while (pArgs->bRunFlag)
    {
        ...
        if(MI_SUCCESS == s32Ret)
        {
            ...
            MI_SYS_FlushCache(stBufInfo.stFrameData.pVirAddr[0], u32YSize);
            MI_SYS_FlushCache(stBufInfo.stFrameData.pVirAddr[1], u32YSize >> 1);
...
int ST_VencH26X(void)
{
    ...
    for (i = 0; i < u32VencNum; i ++)
    {
        ...
        if (E_MI_VENC_MODTYPE_H264E == pstCaseDesc[u32CaseIndex].stCaseArgs[i].uChnArg.stVencChnArg.eType)
        {
            ...
            stChnAttr.stRcAttr.stAttrH264Cbr.u32SrcFrmRate =
                pstCaseDesc[u32CaseIndex].stCaseArgs[i].uChnArg.stVencChnArg.s32MainFrmRate;
        ...
        else if (E_MI_VENC_MODTYPE_H265E == pstCaseDesc[u32CaseIndex].stCaseArgs[i].uChnArg.stVencChnArg.eType)
        {
            ...
            stChnAttr.stRcAttr.stAttrH265Cbr.u32SrcFrmRate =
                pstCaseDesc[u32CaseIndex].stCaseArgs[i].uChnArg.stVencChnArg.s32MainFrmRate;
