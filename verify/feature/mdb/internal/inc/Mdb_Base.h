...
#define MDB_EXPECT_OK(testcaseName, testcaseStr, ret) MDB_EXPECT(testcaseName, testcaseStr, (ret == MI_RGN_OK))
#define MDB_EXPECT_FAIL(testcaseName, testcaseStr, ret) MDB_EXPECT(testcaseName, testcaseStr, (ret != MI_RGN_OK))
#define MDB_EXPECT_OK_ERRCASE(testcaseName, testcaseStr, ret, errcase) MDB_EXPECT_ERRCASE(testcaseName, testcaseStr, (ret == MI_RGN_OK), errcase)
#define MDB_EXPECT_FAIL_ERRCASE(testcaseName, testcaseStr, ret, errcase) MDB_EXPECT_ERRCASE(testcaseName, testcaseStr, (ret != MI_RGN_OK), errcase)
