...
#define MI_VDF_CHANNEL_MAX            2048
...
#define MI_VDF_CHANNEL_NUM_MAX        16
#define MI_VDF_INPUT_CHN_NUM          0x00

#define MI_VDF_MD_RST_BUF_NUM_MAX     16
...
{
    MI_VDF_Obj_t stMDObjCfg;
    MI_VDF_Rgn_t stMDRgnSet;
    MI_VDF_MDParamsIn_t stMDParamsIn;
    MI_VDF_Color_e enClrType;
    MI_U8  u8SrcChnNum;
    MI_U32 u32MdBufNum;
    MI_U32 u32VDFIntvl;
} MI_VDF_MdAttr_t;
...
{
    MI_VDF_Obj_t stODObjCfg;
    MI_VDF_Rgn_t stODRgnSet;
    MI_VDF_ODParamsIn_t stODParamsIn;
    MI_VDF_Color_e enClrType;
    MI_U8  u8SrcChnNum;
    MI_U32 u32OdBufNum;
    MI_U32 u32VDFIntvl;
...
typedef struct MI_MD_Result_s
{
    ...
    MI_U64 u64MdResult[32];     //The MD result of the sub-window
} MI_MD_Result_t;
...
typedef struct MI_VDF_MdRstHdlList_s
{
    ...
    MI_U16         u16ReadPst;
    MI_S8          s8DeltData;
    MI_MD_Result_t* pstMdResultList;
    void*           next;
