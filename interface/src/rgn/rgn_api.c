...
MI_S32 MI_RGN_Init(MI_RGN_PaletteTable_t *pstPaletteTable)
{
    ...
    MI_RGN_PaletteTable_t stInitPara;

    memset(&stInitPara, 0, sizeof(stInitPara));
    //set &stInit as  MI_RGN_PaletteTable_t *pstPaletteTable

    memcpy(&stInitPara, pstPaletteTable, sizeof(MI_RGN_PaletteTable_t));
    s32Ret = MI_SYSCALL(MI_RGN_INIT, &stInitPara);
#ifndef __KERNEL__
...
static MI_U32 _MI_RGN_Rgb2Yuv(MI_U32 u32RgbColor)
{
    MI_FLOAT fY,fU,fV;
...
#ifndef __KERNEL__
    stAttachToChn.stChnAttr.stCoverPara.u32Color = _MI_RGN_Rgb2Yuv(pstChnAttr->stCoverPara.u32Color);
#endif
...
#ifndef __KERNEL__
    stSetDisplayAttr.stChnAttr.stCoverPara.u32Color = _MI_RGN_Rgb2Yuv(stSetDisplayAttr.stChnAttr.stCoverPara.u32Color);
#endif
