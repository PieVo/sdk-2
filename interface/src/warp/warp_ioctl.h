...
typedef enum
{
    ...
    E_MI_WARP_SETOUTPUTPORTATTR,
    E_MI_WARP_GETOUTPUTPORTATTR,
    E_MI_WARP_SETINPUTPORTATTR,
    E_MI_WARP_GETINPUTPORTATTR,
    E_MI_WARP_CMD_MAX
} MI_WRAP_Cmd_e;
...
typedef struct MI_WARP_TriggleChannel_s
{
    MI_WARP_DEV devId;
    MI_WARP_CHN chnId;
} MI_WARP_TriggerChannel_t;
...
typedef struct MI_WARP_SetInputPortAttr_s
{
    MI_WARP_DEV devId;
    MI_WARP_CHN chnId;
    MI_WARP_PORT portId;
    MI_WARP_InputPortAttr_t stInputPortAttr;
} MI_WARP_SetInputPortAttr_t;

typedef struct MI_WARP_GetInputPortAttr_s
{
    MI_WARP_DEV devId;
    MI_WARP_CHN chnId;
    MI_WARP_PORT portId;
    MI_WARP_InputPortAttr_t stInputPortAttr;
} MI_WARP_GetInputPortAttr_t;

typedef struct MI_WARP_SetOutputPortAttr_s
{
    MI_WARP_DEV devId;
    MI_WARP_CHN chnId;
    MI_WARP_PORT portId;
    MI_WARP_OutputPortAttr_t stOutputPortAttr;
} MI_WARP_SetOutputPortAttr_t;

typedef struct MI_WARP_GetOutputPortAttr_s
{
    MI_WARP_DEV devId;
    MI_WARP_CHN chnId;
    MI_WARP_PORT portId;
    MI_WARP_OutputPortAttr_t stOutputPortAttr;
} MI_WARP_GetOutputPortAttr_t;
...
#define MI_WARP_TRIGGER_CHANNEL     _IOW(MI_WARP_MAGIC, E_MI_WARP_TRIGGER_CHN, MI_WARP_TriggerChannel_t)
...
#define MI_WARP_SETINPUTPORTATTR    _IOW(MI_WARP_MAGIC, E_MI_WARP_SETINPUTPORTATTR, MI_WARP_SetInputPortAttr_t)
#define MI_WARP_GETINPUTPORTATTR    _IOWR(MI_WARP_MAGIC, E_MI_WARP_GETINPUTPORTATTR, MI_WARP_GetInputPortAttr_t)
#define MI_WARP_SETOUTPUTPORTATTR   _IOW(MI_WARP_MAGIC, E_MI_WARP_SETOUTPUTPORTATTR, MI_WARP_SetOutputPortAttr_t)
#define MI_WARP_GETOUTPUTPORTATTR   _IOWR(MI_WARP_MAGIC, E_MI_WARP_GETOUTPUTPORTATTR, MI_WARP_GetOutputPortAttr_t)
