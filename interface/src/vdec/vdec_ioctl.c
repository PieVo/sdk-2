...
static MI_S32 MI_VDEC_IOCTL_GetChnAttr(MI_DEVICE_Context_t *env, void *ptr)
{
    ...
    AUTO_LOCK(env, mutex);
    s32Ret = MI_VDEC_IMPL_GetChnAttr(VdecChn, &stChnAttr);
    memcpy(pstChnAttr, &stChnAttr, sizeof(MI_VDEC_ChnAttr_t));
    return s32Ret;
}
...
static MI_S32 MI_VDEC_IOCTL_GetChnStat(MI_DEVICE_Context_t *env, void *ptr)
{
    ...
    AUTO_LOCK(env, mutex);
    s32Ret = MI_VDEC_IMPL_GetChnStat(VdecChn, &stChnStat);
    memcpy(pstChnStat, &stChnStat, sizeof(MI_VDEC_ChnStat_t));
    return s32Ret;
}
...
static MI_S32 MI_VDEC_IOCTL_GetChnParam(MI_DEVICE_Context_t *env, void *ptr)
{
    ...
    AUTO_LOCK(env, mutex);
    s32Ret = MI_VDEC_IMPL_GetChnParam(VdecChn, &stChnParam);
    memcpy(pstChnParam, &stChnParam, sizeof(MI_VDEC_ChnParam_t));
    return s32Ret;
}
