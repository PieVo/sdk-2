...
#ifdef MI_SYS_PROC_FS_DEBUG
typedef struct stVPECheckFramePts_s
{
    MI_U64 u64Pts;
    MI_BOOL bCheckFramePts;
    MI_U16 u16CheckFramePtsChanId;
    MI_U32 u32CheckFramePtsBufCnt;
}stVPECheckFramePts_t;

typedef struct stVPEStatFrame_s
{
    MI_BOOL bstat;
    MI_BOOL bFirstSet;
    MI_U16 u16StatChanId;
    MI_U32 u32StatBufCnt;
...
typedef struct stVPEStatFrameTimer_s
{
    struct timer_list Timer;
    MI_BOOL bCreate;
}stVPEStatFrameTimer_t;
