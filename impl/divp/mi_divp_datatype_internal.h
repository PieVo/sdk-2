...
#if defined(MI_SYS_PROC_FS_DEBUG) &&(MI_DIVP_PROCFS_DEBUG == 1)
typedef struct mi_divp_StatFrame_s
{
    MI_BOOL bEnable;
    MI_BOOL bstat;
    MI_BOOL bCheckFrameID;
    MI_BOOL bFirstSet;
    MI_U16 u16CheckFrameIDChanId;
    MI_U16 u16StatChanId;
    MI_U32 u32CheckFrameIDBufCnt;
...
typedef struct mi_divp_StatFrameTimer_s
{
    struct timer_list Timer;
    MI_BOOL bCreate;
}mi_divp_StatFrameTimer_t;
