...
static int mi_disp_cus_allcator_add_new_allocation(mi_disp_inputport_allocator_t *pst_inport_allocator,
                                     MI_PHY phyAddr,  MI_U32 u32Width, MI_U32 u32Height, MI_U32 u32Stride, MI_SYS_PixelFormat_e  ePixelFormat, MI_SYS_BufferAllocation_t *pstParentMMAAllocation)
{
     mi_disp_inputport_allocation_t *pst_inport_allocation;
...
#endif //if MI_DISP_ENABLE_CUS_ALLOCATOR
